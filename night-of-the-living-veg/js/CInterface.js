function CInterface() {
    ...
    this.levelComplete = function (iLevel, iScore, iEnemyKilled, iLevelScore) {
        ...
        if (iLv < OBJECTS_LEVEL_POSITION.length) {
            ...
            var oData = {
                ...
                frames: {width: oSpriteEnemyLeftRight.width / 8, height: oSpriteEnemyLeftRight.height / 3, regX: (oSpriteEnemyLeftRight.width / 2) / 8 + ENEMY_OFFSET_REG[0].x, regY: (oSpriteEnemyLeftRight.height / 2) / 3 + ENEMY_OFFSET_REG[0].y},
                animations: {walk: [0, 7, "walk", 0.5], escape: [8, 15, "attack", 0.5], die: [16, 23, "die", 0.5]}
            };
            var oSpriteSheetHeroLeftRight = new createjs.SpriteSheet(oData);

            oEnemyDied = createSprite(oSpriteSheetHeroLeftRight, 23, ((oSpriteEnemyLeftRight.width / 2) / 8) + ENEMY_OFFSET_REG[0].x, 
                                                        ((oSpriteEnemyLeftRight.height / 2) / 3) + ENEMY_OFFSET_REG[0].y, oSpriteEnemyLeftRight.width / 8, 
                                                          oSpriteEnemyLeftRight.height / 3);
            oEnemyDied.gotoAndStop(19);
    ...
    this.helpPag1 = function (iLv) {
        ...
        oHelpTitle = new createjs.Text(TEXT_HOW_TO_PLAY, "normal " + 50 + "px " + PRIMARY_FONT, "#ffb400");
        ...
        oHelpTitleStruct = new createjs.Text(TEXT_HOW_TO_PLAY, "normal " + 50 + "px " + PRIMARY_FONT, "#000000");
        ...
        oHelpText = new createjs.Text(szHelpText, "normal " + 50 + "px " + PRIMARY_FONT, "#ffb400");
        ...
        oHelpTextStruct = new createjs.Text(szHelpText, "normal " + 50 + "px " + PRIMARY_FONT, "#000000");
    ...
    this.helpPag2 = function (iLv) {
        ...
        oHelpTextEnemy = new createjs.Text(TEXT_HELP_ENEMY, "normal " + 50 + "px " + PRIMARY_FONT, "#ffb400");
        ...
        oHelpTextEnemyStruct = new createjs.Text(TEXT_HELP_ENEMY, "normal " + 50 + "px " + PRIMARY_FONT, "#000000");
        ...
        oEnemy = createSprite(oSpriteSheetHeroLeftRight, "walk", ((oSpriteEnemyLeftRight.width / 2) / 8) + ENEMY_OFFSET_REG[0].x, ((oSpriteEnemyLeftRight.height / 2) / 3) + ENEMY_OFFSET_REG[0].y, oSpriteEnemyLeftRight.width / 8, oSpriteEnemyLeftRight.height / 3);
        ...
        oHelpTextTNT = new createjs.Text(TEXT_HELP_TNT, "normal " + 50 + "px " + PRIMARY_FONT, "#ffb400");
        ...
        oHelpTextTNTStruct = new createjs.Text(TEXT_HELP_TNT, "normal " + 50 + "px " + PRIMARY_FONT, "#000000");
        ...
        oTNT = createSprite(oSpriteSheetTNT, "normal", ((oSpriteTNT.width / 2) / OBJECT_SPRITESHEET_NUM[iType].width) + OFFSET_REG_OBJECT[iType].x, ((oSpriteTNT.height / 2) / OBJECT_SPRITESHEET_NUM[iType].height) + OFFSET_REG_OBJECT[iType].y, oSpriteTNT.width / OBJECT_SPRITESHEET_NUM[iType].width, oSpriteTNT.height / OBJECT_SPRITESHEET_NUM[iType].height);
        ...
        oHelpTextCoin = new createjs.Text(TEXT_HELP_COIN_PART1 + " ", "normal " + 50 + "px " + PRIMARY_FONT, "#ffb400");
        ...
        oHelpTextCoinStruct = new createjs.Text(TEXT_HELP_COIN_PART1 + " ", "normal " + 50 + "px " + PRIMARY_FONT, "#000000");
        ...
        var oPosHelpTextSword = {x: -200, y: 300};

        oHelpTextSword = new createjs.Text(TEXT_HELP_SWORD, "normal " + 50 + "px " + PRIMARY_FONT, "#ffb400");
        ...
        oHelpTextSwordStruct = new createjs.Text(TEXT_HELP_SWORD, "normal " + 50 + "px " + PRIMARY_FONT, "#000000");
