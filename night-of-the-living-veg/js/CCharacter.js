function CCharacter(iXPos, iYPos, iRow, iCol) {
    ...
    this._init = function (iXPos, iYPos, iRow, iCol) {
        ...
        var oData = {
            ...
            frames: {width: (oSpriteHeroBottom.width / 8), height: oSpriteHeroBottom.height / 4, regX: (oSpriteHeroBottom.width / 2) / 8 + CHARACTER_OFFSET_REG.x, regY: (oSpriteHeroBottom.height / 2) / 4 + CHARACTER_OFFSET_REG.y},
            animations: {idle: [0, 0, "idle", 0.5], walk: [0, 7, "walk", 0.5], attack: [8, 15, "attack", 0.5], die: [16, 25, "die", 0.5]}
        };
        ...
        _oHeroBottom = createSprite(oSpriteSheetHeroBottom, "idle", ((oSpriteHeroBottom.width / 2) / 8) + CHARACTER_OFFSET_REG.x, ((oSpriteHeroBottom.height / 2) / 4) + CHARACTER_OFFSET_REG.y, oSpriteHeroBottom.width / 8, oSpriteHeroBottom.height / 4);
        _iSelectedHero = 0;
    ...
    this.createHeroLeft = function () {
        ...
        var oData = {
            ...
            // width, height & registration point of each sprite
            frames: {width: oSpriteHeroLeft.width / 8, height: oSpriteHeroLeft.height / 5, regX: (oSpriteHeroLeft.width / 2) / 8 + CHARACTER_OFFSET_REG.x, regY: (oSpriteHeroLeft.height / 2) / 5 + CHARACTER_OFFSET_REG.y},
            animations: {idle: [26, 33, "idle", 0.5], walk: [0, 7, "walk", 0.5], attack: [8, 15, "attack", 0.5], die: [16, 25, "die", 0.5]}
        };
        var oSpriteSheetHeroLeft = new createjs.SpriteSheet(oData);
        _oHeroLeft = createSprite(oSpriteSheetHeroLeft, "idle", ((oSpriteHeroLeft.width / 2) / 8) + CHARACTER_OFFSET_REG.x, ((oSpriteHeroLeft.height / 2) / 5) + CHARACTER_OFFSET_REG.y, oSpriteHeroLeft.width / 8, oSpriteHeroLeft.height / 5);
    };
    ...
    this.createHeroRight = function () {
        ...
        var oData = {
            ...
            // width, height & registration point of each sprite
            frames: {width: oSpriteHeroRight.width / 8, height: oSpriteHeroRight.height / 5, regX: (oSpriteHeroRight.width / 2) / 8 + CHARACTER_OFFSET_REG.x, regY: (oSpriteHeroRight.height / 2) / 5 + CHARACTER_OFFSET_REG.y},
            animations: {idle: [26, 33, "idle", 0.5], walk: [0, 7, "walk", 0.5], attack: [8, 15, "attack", 0.5], die: [16, 25, "die", 0.5]}
        };
        var oSpriteSheetHeroRight = new createjs.SpriteSheet(oData);
        _oHeroRight = createSprite(oSpriteSheetHeroRight, "idle", ((oSpriteHeroRight.width / 2) / 8) + CHARACTER_OFFSET_REG.x, ((oSpriteHeroRight.height / 2) / 5) + CHARACTER_OFFSET_REG.y, oSpriteHeroRight.width / 8, oSpriteHeroRight.height / 5);
    };
    ...
    this.createHeroTop = function () {
        ...
        var oData = {
            ...
            // width, height & registration point of each sprite
            frames: {width: oSpriteHeroTop.width / 8, height: oSpriteHeroTop.height / 4, regX: (oSpriteHeroTop.width / 2) / 8 + CHARACTER_OFFSET_REG.x, regY: (oSpriteHeroTop.height / 2) / 4 + CHARACTER_OFFSET_REG.y},
            animations: {idle: [0, 0, "idle", 0.5], walk: [0, 7, "walk", 0.5], attack: [8, 15, "attack", 0.5], die: [16, 25, "die", 0.5]}
        };
        var oSpriteSheetHeroTop = new createjs.SpriteSheet(oData);
        _oHeroTop = createSprite(oSpriteSheetHeroTop, "idle", ((oSpriteHeroTop.width / 2) / 8) + CHARACTER_OFFSET_REG.x, ((oSpriteHeroTop.height / 2) / 4) + CHARACTER_OFFSET_REG.y, oSpriteHeroTop.width / 8, oSpriteHeroTop.height / 4);
    };
