(function() {
    ...
    var p = c.extend(Slot17, c.Container);
    p._active = false;
    p.initialize = function() {
        console.log('Slot17 int');
        ...
        this.shape.graphics.f("#FF0000").s().p("AEQFhQlAAEilDpQmLgQi6CEIgDgGIkn2gMAiJAA1IgdOQIm3IEQgOkVlThvg");
    ...
    window.Slot17 = c.promote(Slot17, "Container");
}());