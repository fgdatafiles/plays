...
(function(){
    'use strict';
    var t;
    function FrameBtt2(_bgd,_bgdOver,colorOver,data,_target)
    {
    ...
    var frameBtt2 = createjs.extend(FrameBtt2, createjs.Container);

    frameBtt2.initialize=function(_bgd,_bgdOver,colorOver,data,_target)
    {
    ...
    function click(e)
     {
         ...
         createjs.EventDispatcher.initialize(FrameBtt2.prototype);
    ...
    window.FrameBtt2 = createjs.promote(FrameBtt2, "Container");
}());
