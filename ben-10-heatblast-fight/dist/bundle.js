...
/***/ function(module, exports, __webpack_require__) {
	...
	var _GameEnd = __webpack_require__(130);
	
	var _GameEnd2 = _interopRequireDefault(_GameEnd);
	
	var _screenfullMin = __webpack_require__(132);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Opponent = __webpack_require__(113);
	
	var _Opponent2 = _interopRequireDefault(_Opponent);
	
	var _OpponentBackground = __webpack_require__(114);
	
	var _OpponentBackground2 = _interopRequireDefault(_OpponentBackground);
	
	var _CenterBlast = __webpack_require__(115);
	
	var _CenterBlast2 = _interopRequireDefault(_CenterBlast);
	...
	var _EffectBeam = __webpack_require__(118);
	
	var _EffectBeam2 = _interopRequireDefault(_EffectBeam);
	...
	var _class = function (_Phaser$State) {
	  ...
	  (0, _createClass3.default)(_class, [{
	    ...
	    value: function create() {
	      ...
	      this.hero.position.set(45, 550);
	
	      this.opponent = new _Opponent2.default(this.game);
	      this.opponent.position.set(1550, 500);
	
	      //Setup background enemies
	      this.opponentBackground1 = new _OpponentBackground2.default(this.game);
	      this.opponentBackground1.position.set(750, 350);
	      this.opponentBackground1.scale.set(-0.25, 0.25);
	      this.opponentBackground1.alpha = 0.85;
	
	      this.opponentBackground2 = new _OpponentBackground2.default(this.game);
	      this.opponentBackground2.position.set(1100, 360);
	      this.opponentBackground2.scale.set(0.25);
	      this.opponentBackground2.alpha = 0.9;
	
	      this.opponentBackground3 = new _OpponentBackground2.default(this.game);
	      this.opponentBackground3.position.set(1500, 300);
	      this.opponentBackground3.scale.set(0.15);
	      this.opponentBackground3.alpha = 0.75;
	
	      this.opponentBackground4 = new _OpponentBackground2.default(this.game);
	      this.opponentBackground4.position.set(400, 350);
	      this.opponentBackground4.scale.set(-0.25, 0.25);
	      this.opponentBackground4.alpha = 0.9;
	
	      this.opponentBackground5 = new _OpponentBackground2.default(this.game);
	      this.opponentBackground5.position.set(550, 300);
	      this.opponentBackground5.scale.set(-0.15, 0.15);
	      this.opponentBackground5.alpha = 0.75;
	
	      this.opponentBackground6 = new _OpponentBackground2.default(this.game);
	      this.opponentBackground6.position.set(1650, 350);
	      this.opponentBackground6.scale.set(0.2);
	      this.opponentBackground6.alpha = 0.85;
	
	      this.opponentBackground7 = new _OpponentBackground2.default(this.game);
	      this.opponentBackground7.position.set(1400, 350);
	      this.opponentBackground7.scale.set(0.2);
	      this.opponentBackground7.alpha = 0.8;
	
	      this.opponentBackground8 = new _OpponentBackground2.default(this.game);
	      this.opponentBackground8.position.set(300, 300);
	      this.opponentBackground8.scale.set(-0.15, 0.15);
	      this.opponentBackground8.alpha = 0.8;
	
	      // create player beam, position it and set it to default half width
	      this.playerBar = new _EffectBeam2.default(this.game, 0, 0, "hero_blast");
	      this.playerBar.position.set(this.game.width / 2 - this.playerBar.width / 2, this.hero.y + this.hero.height * 0.44);
	      this.playerBar.setBeamWidth(0.5);
	
	      // create opponent beam, position it and set it to default half width
	      this.cpuBar = new _EffectBeam2.default(this.game, 0, 0, "opponent_blast", "right");
	      this.cpuBar.position.set(this.game.width / 2 + this.cpuBar.width / 2, this.opponent.y + this.opponent.height * 0.55);
	      this.cpuBar.setBeamWidth(0.5);
	
	      // create impact animation
	      this.centerBlast = new _CenterBlast2.default(this.game);
	      this.centerBlast.position.set(this.playerBar.x + this.playerBar.width * 0.5, this.playerBar.y);
	
	      this.cpuTPSArray = [5, 7, 11, 12, 14, 8, 4, 6, 10, 12, 5, 6, 11, 8, 9, 5, 8, 10, 8, 6, 35];
	      this.cpuTPSTimeSwitch = 1000;
	      this.cpuTPSTimer = 0;
	      this.cpuTPS = 0;
	      this.moveDist = 15;
	      this.userPower = 0;
	      ...
	      this.tapTimer = this.game.time.now;
	
	      this.taps = 0;
	      this.startTap = this.game.time.now;
	
	      this.offsetCenter = this.game.width / 2;
	      this.gameEnd = false;
	      this.winner = false;
	      this.majorityWinner = undefined;
	      this.timeEnd = undefined;
	
	      this.gameTime = 30000;
	      this.hud = new _GameHUD2.default(this.game, { clock: true });
	      this.hud.setTimeDisplay(this.gameTime);
	      ...
	      this.gameContainer.addChild(this.opponent);
	      this.gameContainer.addChild(this.opponentBackground1);
	      this.gameContainer.addChild(this.opponentBackground2);
	      this.gameContainer.addChild(this.opponentBackground3);
	      this.gameContainer.addChild(this.opponentBackground4);
	      this.gameContainer.addChild(this.opponentBackground5);
	      this.gameContainer.addChild(this.opponentBackground6);
	      this.gameContainer.addChild(this.opponentBackground7);
	      this.gameContainer.addChild(this.opponentBackground8);
	      this.gameContainer.addChild(this.playerBar);
	      this.gameContainer.addChild(this.cpuBar);
	      this.gameContainer.addChild(this.centerBlast);
	
	      this.game.add.existing(this.gameContainer);
	      this.game.add.existing(this.hud);
	
	      this.opponentBoost = false;
	    ...
	    value: function update() {
	      ...
	      switch (this.state) {
	        ...
	        case 2:
	          ...
	          // update cpu tps timer so we now how many taps per second it's running at
	
	          if (!this.game.sounds.isSoundPlaying("fire_water")) this.game.sounds.playSoundEffect("fire_water", true, 0.5);
	
	          this.cpuTPSTimer += this.timeStamp.timeStep;
	          if (this.cpuTPSTimer > this.cpuTPSTimeSwitch) {
	            this.cpuTPS++;
	            if (this.cpuTPS >= this.cpuTPSArray.length - 1) this.cpuTPS = 0;
	            this.cpuTPSTimer = 0;
	          }
	
	          //If the game is finished and the cpu won
	          if (this.gameTime <= 0 && this.majorityWinner === false) {
	            this.cpuTPS = this.cpuTPSArray.length - 1;
	          }
	
	          var finalPower = (this.userPower - this.cpuTPSArray[this.cpuTPS]) * this.moveDist / 1000 || 0;
	          this.offsetCenter = this.offsetCenter += finalPower * this.timeStamp.timeStep;
	
	          this.userPower *= 0.99;
	
	          this.centerBlast.x += finalPower * this.timeStamp.timeStep;
	          var playerPercent = (this.centerBlast.x - this.playerBar.x) / this.playerBar.width;
	          this.playerBar.setBeamWidth(playerPercent);
	          this.cpuBar.setBeamWidth(1 - playerPercent);
	
	          if (playerPercent < 0.1) this.triggerGameEnd(false);
	          if (playerPercent > 0.9) this.triggerGameEnd(true);
	
	          this.gameTime = Math.max(0, this.gameTime - this.timeStamp.timeStep);
	          this.hud.setTimeDisplay(this.gameTime);
	          if (this.game <= 5000) {
	            if (!this.game.sounds.isSoundPlaying("timesup")) {
	              this.game.sounds.playSoundEffect("timesup", true, 1);
	            }
	          }
	          if (this.gameTime <= 0) {
	            this.game.input.onDown.remove(this.handleUserInput, this);
	            //Player won majority
	            if (this.offsetCenter > this.game.width / 2) {
	              this.majorityWinner = true;
	              this.userPower = 35;
	            }
	
	            //Player lost majority
	            else {
	                this.userPower = 0;
	        ...
	        case 3:
	          // is ending
	          if (this.game.time.now - this.timeEnd > 2000) this.game.state.start("GameEnd", true, false, this.winner);
	          break;
	        case 4:
	          // is ended
	          this.timeEnd -= this.timeStamp.timeStep;
	          if (this.timeEnd <= 0) this.game.state.start("GameEnd", true, false, this.winner);
	          break;
	      }
	    }
	  }, {
	    ...
	    key: 'triggerGameEnd',
	    value: function triggerGameEnd(winner, animation) {
	      this.game.sounds.stopSound("fire_water");
	      ...
	      if (winner) {
	        this.opponent.die();
	        this.game.sounds.playSoundEffect("fire_win", false, 1);
	        this.cpuBar.visible = false;
	        this.playerBar.visible = false;
	        this.centerBlast.visible = false;
	      } else {
	        this.cpuBar.visible = false;
	        this.playerBar.visible = false;
	        this.centerBlast.visible = false;
	
	        this.hero.palm.visible = false;
	
	        this.game.sounds.playSoundEffect("water_win", false, 1);
	
	        this.deathUnderlay = this.game.add.sprite(0, 0, "hero_loose_underlay");
	        this.deathUnderlay.anchor.set(0, 0.5);
	        this.deathUnderlay.position.set(this.hero.x + this.hero.width * 0.1, this.hero.y + this.hero.height * 0.9);
	        this.gameContainer.addChild(this.deathUnderlay);
	
	        this.gameContainer.bringToTop(this.hero);
	
	        this.deathOverlay = this.game.add.sprite(0, 0, "hero_loose_overlay");
	        this.deathOverlay.anchor.set(0.5);
	        this.deathOverlay.animations.add("play");
	        this.deathOverlay.animations.play("play", 24);
	        this.deathOverlay.position.set(this.hero.x + this.hero.width / 2, this.hero.y);
	        this.gameContainer.addChild(this.deathOverlay);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _class = function (_Phaser$Sprite) {
	    ...
	    function _class(game, x, y, asset) {
	        ...
	        var _this = (0, _possibleConstructorReturn3.default)(this, (_class.__proto__ || (0, _getPrototypeOf2.default)(_class)).call(this, game, x, y, "hero_body"));
	
	        _this.animationTick = 0;
	        _this.animations.add("play");
	        _this.animations.currentAnim.onComplete.add(_this.handleAnimationDone, _this);
	        _this.handleAnimationDone();
	
	        _this.head = _this.game.make.sprite(_this.width * 0.43, _this.height * 0.26, "hero_head");
	        _this.head.anchor.set(0, 1);
	        _this.head.animations.add("play");
	        _this.head.animations.play("play", 24, true);
	
	        _this.palm = _this.game.make.sprite(_this.width * 0.86, _this.height * 0.27, "hero_palm");
	        _this.palm.animations.add("play");
	        _this.palm.animations.play("play", 24, true);
	        _this.addChild(_this.palm);
	    ...
	    (0, _createClass3.default)(_class, [{
	        key: "update",
	        value: function update() {
	            if (this.allowAnimation && this.game.time.now > this.nextAnimation) {
	                this.allowAnimation = false;
	                this.animationTick = 2 + Math.round(Math.random() * 3);
	                this.animations.play("play", 24);
	            }
	        }
	    }, {
	        key: "handleAnimationDone",
	        value: function handleAnimationDone() {
	            this.animationTick--;
	            if (this.animationTick > 0) {
	                this.animations.play("play", 24);
	            } else {
	                this.allowAnimation = true;
	                this.nextAnimation = this.game.time.now + Math.random() * 1000;
	            }
	        }
	    }, {
	        key: "destroy",
	        value: function destroy() {
	            this.animations.currentAnim.onComplete.remove(this.handleAnimationDone, this);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _class = function (_Phaser$Sprite) {
	    ...
	    function _class(game, x, y, asset) {
	        ...
	        var _this = (0, _possibleConstructorReturn3.default)(this, (_class.__proto__ || (0, _getPrototypeOf2.default)(_class)).call(this, game, x, y, "opponent"));
	
	        _this.animationTick = 0;
	        _this.animations.add("play");
	        _this.animations.currentAnim.onComplete.add(_this.handleAnimationDone, _this);
	        _this.animations.play("play", 24);
	    ...
	    (0, _createClass3.default)(_class, [{
	        ...
	        value: function die() {
	            ...
	            this.animations.currentAnim.onComplete.remove(this.handleAnimationDone, this);
	            this.loadTexture("opponent_death");
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _class = function (_Phaser$Sprite) {
	    ...
	    function _class(game, x, y, asset) {
	        ...
	        var _this = (0, _possibleConstructorReturn3.default)(this, (_class.__proto__ || (0, _getPrototypeOf2.default)(_class)).call(this, game, x, y, "bg_character"));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _class = function (_Phaser$Sprite) {
	  ...
	  function _class(game, x, y) {
	    ...
	    var _this = (0, _possibleConstructorReturn3.default)(this, (_class.__proto__ || (0, _getPrototypeOf2.default)(_class)).call(this, game, x, y, "center_blast"));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _class = function (_Phaser$Sprite) {
	  ...
	  function _class(game, x, y, asset) {
	    ...
	    var _this = (0, _possibleConstructorReturn3.default)(this, (_class.__proto__ || (0, _getPrototypeOf2.default)(_class)).call(this, game, x, y, asset));
	
	    _this.game = game;
	    _this.size = 60 + Math.random() * 60;
	    _this.costume = _this.game.make.graphics();
	    _this.costume.beginFill(0x505050);
	    _this.costume.drawCircle(0, 0, _this.size);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _class = function (_Phaser$Sprite) {
	  ...
	  function _class(game, x, y, spritesheet, side) {
	    (0, _classCallCheck3.default)(this, _class);
	
	    var _this = (0, _possibleConstructorReturn3.default)(this, (_class.__proto__ || (0, _getPrototypeOf2.default)(_class)).call(this, game, x, y));
	
	    _this.beam = _this.game.make.sprite(0, 0, spritesheet);
	
	    _this.beam.animations.add("play");
	    _this.beam.animations.play("play", 12, true);
	
	    _this.mask = _this.game.add.graphics();
	    _this.mask.beginFill(0xFFFFFF);
	
	    if (side == "right") {
	      _this.beam.anchor.set(1, 0.5);
	      _this.mask.drawRect(0, 0, -_this.beam.width, _this.beam.height);
	    } else {
	      _this.beam.anchor.set(0, 0.5);
	      _this.mask.drawRect(0, 0, _this.beam.width, _this.beam.height);
	    }
	
	    _this.mask.position.set(0, -(_this.beam.height / 2));
	
	    _this.addChild(_this.beam);
	    _this.addChild(_this.mask);
	
	    _this.beam.mask = _this.mask;
	
	    Object.defineProperty(_this, 'width', { get: function get() {
	        return this.beam.width;
	      } });
	    return _this;
	  }
	  ...
	  (0, _createClass3.default)(_class, [{
	    key: "setBeamWidth",
	    value: function setBeamWidth(percent) {
	      this.mask.scale.x = percent;
	    }
	  }]);
	  return _class;
	}(Phaser.Sprite);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _IntructionSpace = __webpack_require__(125);
	
	var _IntructionSpace2 = _interopRequireDefault(_IntructionSpace);
	
	var _IntructionTapScreen = __webpack_require__(126);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _BtnPlay = __webpack_require__(129);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _BtnReplay = __webpack_require__(131);
	...
	var _class = function (_Phaser$State) {
	    ...
	    (0, _createClass3.default)(_class, [{
	        ...
	        value: function create() {
	            ...
	            this.background = this.game.add.sprite(0, 0, this.win ? "bg_win" : "bg_loose");
	            this.endIcon = this.game.add.sprite(0, 0, this.win ? "icon_win" : "icon_loose");
	            ...
	            this.game.add.existing(this.endIcon);
	
	            this.btnReplay.events.onInputUp.add(this.handlePlayButton, this);
	            game.time.events.add(1000, this.allowButton, this).autoDestroy = true;
	        }
	    }, {
	        key: 'renderDefault',
	        value: function renderDefault() {
	            this.endIcon.position.set(this.game.width / 2, 317);
	            this.btnReplay.position.set(this.game.width / 2, 800);
	            this.btnReplay.scale.set(0);
	        }
	    }, {
	        key: 'renderPromotedGames',
	        value: function renderPromotedGames() {
	            this.endIcon.position.set(this.game.width * 0.32, this.game.height * 0.3);
	            this.btnReplay.position.set(this.game.width * 0.62, this.game.height * 0.3);
	            this.btnReplay.scale.set(0);
	        ...
	        value: function allowButton() {
	            ...
	            this.game.add.tween(this.btnReplay.scale).to({ x: 1, y: 1 }, 100).start();
	        }
	    }, {
	        key: 'handlePlayButton',
	        value: function handlePlayButton() {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _defineProperties = __webpack_require__(133);
