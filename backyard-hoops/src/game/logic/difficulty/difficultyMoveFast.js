...
DifficultyBasketMoveFast = function(parent, minRange, maxRange){
    DifficultyAbstractUnit.call(this, true, parent, minRange, maxRange);
    this.setJerryBlockIndex(2);
}

DifficultyBasketMoveFast.prototype = new DifficultyAbstractUnit;
DifficultyBasketMoveFast.prototype.constructor = DifficultyBasketMoveFast;

DifficultyBasketMoveFast.prototype.doAction = function(amountBallsInside){
    ...
    }else
    {
        ...
        this.parentClass.parentClass.basket.setFastVelocity();
    }
}

DifficultyBasketMoveFast.prototype.getBallType = function(maxLives, currentLives, amountBallsInside){
