(function() {
    ...
    function over(e) {
        ...
        TweenLite.to(e.currentTarget.bgdOver, 0.3, {
            alpha: 1,
            ease: Sine.easeOut
        });
        TweenLite.to(e.currentTarget.bgd, 0.3, {
            alpha: 0,
            ease: Sine.easeIn
        });
    ...
    function out(e) {
        ...
        if (e.currentTarget.txt) {
            e.currentTarget.txt.color = '#FFFF00';
        }
        TweenLite.to(e.currentTarget.bgdOver, 0.3, {
            alpha: 0,
            ease: Sine.easeIn
    ...
    frameBtt.resetClick = function() {
        ...
        TweenLite.to(this.bgdOver, 0.3, {
            alpha: 0,
            ease: Sine.easeIn
        });
        TweenLite.to(this.bgd, 0.3, {
            alpha: 1,
            ease: Sine.easeOut
        });
        this.addEventListener('mouseover', over);
