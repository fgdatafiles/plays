var keyPressed;
var iTimerFinished = false;
var bDoOnceDeath = false;
var bDoOnceGameover = false;
var bCollided = false;
var bTutorialOpen = false;
...
var game = {
    ...
    onload: function() {
        ...
        me.game.sortOn =
            "y";
        if (!0 === me.game.HASH.debug) window.onReady(function() {
        ...
        me.device.wp ? PREFS.AUDIOENABLED.value = !1 : me.audio.init("mp3,ogg");
        ...
        game.resources = me.device.isMobile ? game.resources.concat(game.resourcesGFX_mobile) :
            game.resources.concat(game.resourcesGFX_desktop);
        for (a = 0; a < PREFS.MAP_FILES.value.length; a++) game.resources = SID ? game.resources.concat([{
            name: PREFS.MAP_FILES.value[a].slice(0, -4),
            type: "image",
        ...
        for (a = 0; a < PREFS.LEVELS_FILES.value.length; a++) game.resources = SID ? game.resources.concat([{
            ...
            type: "tmx",
            src: "users/" + SID +
                "/" + PREFS.LEVELS_FILES.value[a]
        }]) : game.resources.concat([{
            name: "level" + (a + 1),
            type: "tmx",
            src: "data/map/" + PREFS.LEVELS_FILES.value[a]
        }]);
        for (a = 0; a < PREFS.SPRITES_FILES.value.length; a++) game.resources = SID ? game.resources.concat([{
            name: PREFS.SPRITES_FILES.value[a].slice(0, -4),
            type: "image",
        ...
        me.state.set(me.state.LOADING,
            new CustomLoadingScreen);
        me.loader.onload = this.loaded.bind(this);
        me.loader.load({
            name: "loading",
            type: "image",
            src: "data/img/gui/Gnasher_FrontFull_Scaled.png"
        }, function() {
    ...
    loaded: function() {
        ...
        me.state.set(me.state.USER +
            2, new game.HowToPlayScreen);
        ...
        me.input.bindGamepad(0, me.input.GAMEPAD.BUTTONS.UP,
            me.input.KEY.UP);
        ...
        me.input.bindGamepad(0, me.input.GAMEPAD.BUTTONS.FACE_1, me.input.KEY.P);
        me.input.bindGamepad(0, me.input.GAMEPAD.BUTTONS.FACE_2, me.input.KEY.P);
        me.input.bindGamepad(0, me.input.GAMEPAD.BUTTONS.FACE_3, me.input.KEY.P);
        me.input.bindGamepad(0, me.input.GAMEPAD.BUTTONS.FACE_4,
            me.input.KEY.P);
        me.input.bindGamepad(0, me.input.GAMEPAD.BUTTONS.FACE_5, me.input.KEY.P);
        me.input.bindGamepad(0, me.input.GAMEPAD.BUTTONS.FACE_6, me.input.KEY.P);
...
game.resourcesGFX_mobile = [{
    ...
    type: "image",
    src: "data/img/gui/TutorialScreenSwipe.png"
}];
game.resourcesGFX_desktop = [{
    ...
    name: "instructions_img",
    type: "image",
    src: "data/img/gui/TutorialScreenKeyboard.png"
}];
game.resources = [{
        name: "gui_bg",
        type: "image",
        src: "data/img/gui/AnimMainTest2.png"
    }, {
		name: "gui_bg_still",
        type: "image",
        src: "data/img/gui/TownStillBG.png"
    }, {
		name: "tutorial_play_button",
        type: "image",
        src: "data/img/gui/tutorialPlayButton.png"
    }, {
		name: "mission_failed",
        type: "image",
        src: "data/img/gui/Mock_Fail_Win.png"
    }, {
		name: "mission_win",
        type: "image",
        src: "data/img/gui/Mock_Win.png"
    },  {
		name: "mission_16_win",
        type: "image",
        src: "data/img/gui/WinScreenAnim.png"
    }, {
		name: "win_screen_16_title",
        type: "image",
        src: "data/img/gui/Win_Screen_Text.png"
    }, {
		name: "mission_1_text",
        type: "image",
        src: "data/img/gui/Levels/Level1.png"
    }, {
		name: "mission_2_text",
        type: "image",
        src: "data/img/gui/Levels/Level2.png"
    }, {
		name: "mission_3_text",
        type: "image",
        src: "data/img/gui/Levels/Level3.png"
    }, {
		name: "mission_4_text",
        type: "image",
        src: "data/img/gui/Levels/Level4.png"
    }, {
		name: "mission_5_text",
        type: "image",
        src: "data/img/gui/Levels/Level5.png"
    }, {
		name: "mission_6_text",
        type: "image",
        src: "data/img/gui/Levels/Level6.png"
    },{
		name: "mission_7_text",
        type: "image",
        src: "data/img/gui/Levels/Level7.png"
    },{
		name: "mission_8_text",
        type: "image",
        src: "data/img/gui/Levels/Level8.png"
    },{
		name: "mission_9_text",
        type: "image",
        src: "data/img/gui/Levels/Level9.png"
    },{
		name: "mission_10_text",
        type: "image",
        src: "data/img/gui/Levels/Level10.png"
    },{
		name: "mission_11_text",
        type: "image",
        src: "data/img/gui/Levels/Level11.png"
    },{
		name: "mission_12_text",
        type: "image",
        src: "data/img/gui/Levels/Level12.png"
    },{
		name: "mission_13_text",
        type: "image",
        src: "data/img/gui/Levels/Level13.png"
    },{
		name: "mission_14_text",
        type: "image",
        src: "data/img/gui/Levels/Level14.png"
    },{
		name: "mission_15_text",
        type: "image",
        src: "data/img/gui/Levels/Level15.png"
    },{
		name: "mission_16_text",
        type: "image",
        src: "data/img/gui/Levels/Level16.png"
    },{
        name: "cover",
        type: "image",
        ...
        name: "title",
        type: "image",
        src: "data/img/gui/TitleGnashTheftAuto.png"
    }, {
        name: "bitmap_font",
        type: "image",
        ...
        name: "small_button",
        type: "image",
        src: "data/img/gui/Safe_Unlocked2.png"
    }, {
        name: "level_button_lock",
        type: "image",
        src: "data/img/gui/Safe_Locked2.png"
    }, {
        ...
        name: "home_button",
        type: "image",
        src: "data/img/gui/BackButton2.png"
    }, {
        name: "restart_button",
        type: "image",
        ...
        name: "level_select_text",
        type: "image",
        src: "data/img/gui/ChooseALevel.png"
    }, {
        name: "butt_down",
        type: "image",
...
function entityManager(a, b) {
    ...
    a.pos.x + a.width > game.data.Path_Layer.cols * game.data.Path_Layer.tilewidth ? (a.body.vel.x = 0, a.pos.x = 32 * Math.floor((a.pos.x + 16) / 32)) : 0 > a.pos.x && (a.body.vel.x = 0, a.pos.x = 32 * Math.floor((a.pos.x + 16) / 32));
    a.pos.y + a.height > game.data.Path_Layer.rows * game.data.Path_Layer.tileheight ? (a.body.vel.y = 0, a.pos.y = 32 * Math.floor((a.pos.y + 16) / 32)) : 0 > a.pos.y && (a.body.vel.y = 0, a.pos.y = 32 * Math.floor((a.pos.y + 16) / 32));
    var d = getTile(a),
        e = Math.abs(32 * Math.floor((a.pos.x + 16) / 32) - a.pos.x),
        f = Math.abs(32 *
            Math.floor((a.pos.y + 16) / 32) - a.pos.y),
        g = a.velocity;
    8 == (d & a.direction) ? (a.body.vel.y = game.data.playerIsHunter ? -a.powerupVelocity : -a.velocity, a.pos.x = 32 * Math.floor((a.pos.x + 16) / 32), a.body.vel.x = 0) : 2 == (d & a.direction) ? (a.body.vel.y = game.data.playerIsHunter ? a.powerupVelocity : a.velocity, a.pos.x = 32 * Math.floor((a.pos.x + 16) / 32), a.body.vel.x = 0) : 4 == (d & a.direction) ? (a.body.vel.x = game.data.playerIsHunter ? a.powerupVelocity : a.velocity, a.pos.y = 32 * Math.floor((a.pos.y + 16) / 32), a.body.vel.y = 0) : 1 == (d & a.direction) ? (a.body.vel.x =
        game.data.playerIsHunter ? -a.powerupVelocity : -a.velocity, a.pos.y = 32 * Math.floor((a.pos.y + 16) / 32), a.body.vel.y = 0) : e < g && f < g && (a.body.vel.x = 0, a.body.vel.y = 0, a.pos.x = 32 * Math.floor((a.pos.x + 16) / 32), a.pos.y = 32 * Math.floor((a.pos.y + 16) / 32));
    var l = getAheadTile(a);
    8 == (d & a.wantedDirection) && e < g ? (a.body.vel.y = game.data.playerIsHunter ? -a.powerupVelocity : -a.velocity, a.direction = a.wantedDirection, a.pos.x = 32 * Math.floor((a.pos.x + 16) / 32), a.body.vel.x = 0) : 2 == (d & a.wantedDirection) && e < g ? (a.body.vel.y = game.data.playerIsHunter ?
        a.powerupVelocity : a.velocity, a.direction = a.wantedDirection, a.pos.x = 32 * Math.floor((a.pos.x + 16) / 32), a.body.vel.x = 0) : 4 == (d & a.wantedDirection) && f < g ? (a.body.vel.x = game.data.playerIsHunter ? a.powerupVelocity : a.velocity, a.direction = a.wantedDirection, a.pos.y = 32 * Math.floor((a.pos.y + 16) / 32), a.body.vel.y = 0) : 1 == (d & a.wantedDirection) && f < g && (a.body.vel.x = game.data.playerIsHunter ? -a.powerupVelocity : -a.velocity, a.direction = a.wantedDirection, a.pos.y = 32 * Math.floor((a.pos.y + 16) / 32), a.body.vel.y = 0);
    return [d, l]
}

function getTile(a) {
    a = game.data.Path_Layer.getTile(a.pos.x + a.width / 2, a.pos.y + a.height / 2);
    return null != a ? parseInt(a.tileset.getTileProperties(a.tileId - 1 + "1").direction, 2) : 0
}
...
function getAheadTile(a) {
    ...
    return null != a ? (property = a.tileset.getTileProperties(a.tileId - 1 + "1"), "undefined" != typeof property ? parseInt(property.direction, 2) : 0) : 0
}
...
function getBacksideTile(a) {
    ...
    return null != a ? parseInt(game.data.Path_Layer.tilesets.getTilesetByGid(a).getTileProperties(a - 1 + "1").direction, 2) : 0
}
...
game.PlayerEntity = me.Entity.extend({
    init: function(a, b, d) {
        ...
        this.renderable.addAnimation("right_stand", PREFS.PLAYER_ANIMATION_NORMAL_RIGHT_STAND.value,
            60);
        ...
        this.renderable.addAnimation("up_stand_hunter", PREFS.PLAYER_ANIMATION_POWER_UP_UP_STAND.value,
            60);
        ...
        this.renderable.addAnimation("right_hunter",
            PREFS.PLAYER_ANIMATION_POWER_UP_RIGHT_WALK.value, 60);
        ...
        this.renderable.addAnimation("left_stand_power_down",
            PREFS.PLAYER_ANIMATION_POWER_DOWN_LEFT_STAND.value, 60);
        ...
        this.renderable.addAnimation("victory", PREFS.PLAYER_ANIMATION_VICTORY.value,
            60);
        ...
        this.powerupVelocity =
            null != d.powerup_velocity ? parseInt(d.powerup_velocity) / PREFS.MAX_FPS.value : PREFS.PLAYER_VELOCITY_ON_POWER_UP.value / PREFS.MAX_FPS.value;
        game.data.playerIsHunter = !1;
        game.data.hunterTimer = 0;
        this.mode = "";
        this.teleportTrigger = "allowed"
		bDoOnceGameover = false;
    },
    update: function(a) {
        if (me.input.isKeyPressed("pause") && game.data.running) {
            ...
            var l = setInterval(function() {
                me.input.isKeyPressed("pause") && (clearInterval(l), PREFS.AUDIOENABLED.value && me.audio.unmuteAll(), me.sys.resumeOnFocus = !0, me.state.resume(), game.data.text = "", me.input.triggerKeyEvent(me.input.KEY.P,
                    !1), me.game.world.removeChild(b.overlay))
            }, 10)
        }
        switch (this.state) {
            case "ready":
				...
				var texture = me.loader.getImage("mission_1_text");
				if (game.data.level === 1)
				{
					texture = me.loader.getImage("mission_1_text");
				}
				else if (game.data.level === 2)
				{
					texture = me.loader.getImage("mission_2_text");
				}
				else if (game.data.level === 3)
				{
					texture = me.loader.getImage("mission_3_text");
				}
				else if (game.data.level === 4)
				{
					texture = me.loader.getImage("mission_4_text");
				}
				else if (game.data.level === 5)
				{
					texture = me.loader.getImage("mission_5_text");
				}
				else if (game.data.level === 6)
				{
					texture = me.loader.getImage("mission_6_text");
				}
				else if (game.data.level === 7)
				{
					texture = me.loader.getImage("mission_7_text");
				}
				else if (game.data.level === 8)
				{
					texture = me.loader.getImage("mission_8_text");
				}
				else if (game.data.level === 9)
				{
					texture = me.loader.getImage("mission_9_text");
				}
				else if (game.data.level === 10)
				{
					texture = me.loader.getImage("mission_10_text");
				}
				else if (game.data.level === 11)
				{
					texture = me.loader.getImage("mission_11_text");
				}
				else if (game.data.level === 12)
				{
					texture = me.loader.getImage("mission_12_text");
				}
				else if (game.data.level === 13)
				{
					texture = me.loader.getImage("mission_13_text");
				}
				else if (game.data.level === 14)
				{
					texture = me.loader.getImage("mission_14_text");
				}
				else if (game.data.level === 15)
				{
					texture = me.loader.getImage("mission_15_text");
				}
				else if (game.data.level === 16)
				{
					texture = me.loader.getImage("mission_16_text");
				}
				
				var levelTextSprite = new levelText(me.video.renderer.getWidth()/2,me.video.renderer.getHeight()/2 -100,0,texture);
				me.game.world.addChild(levelTextSprite);
                me.sys.resumeOnFocus = !1;
                this.overlay = new me.ColorLayer("overlay", new me.Color(0, 0, 0, 0.3), 0);
                me.game.world.addChild(this.overlay, 10);
                this.updateWhenPaused = !0;
                this.handler = me.event.subscribe(me.event.KEYDOWN, function(a, d, e) {
                    if ("up" === a || "down" === a || "left" === a || "right" === a) PREFS.MUSICENABLED.value && me.audio.playTrack("soundtrack"), game.data.text = "", b.renderable && (b.renderable.alpha = 1), me.sys.resumeOnFocus = !0, me.state.resume(),
                        b.renderable && (b.state = "play"), me.event.unsubscribe(b.handler), me.game.world.removeChild(b.overlay),me.game.world.removeChild(levelTextSprite), b.updateWhenPaused = !1, game.data.running = !0
                });
                ...
                break;
            case "wait":
				this.pos.x = this.initialX, this.pos.y = this.initialY;
            ...
            case "play":
				...
				if (keyPressed === 0 || me.input.isKeyPressed("up"))
				{
					d = 8;
				}
				else if (keyPressed === 1|| me.input.isKeyPressed("down"))
				{
					d = 2;
				}
				else if (keyPressed === 2|| me.input.isKeyPressed("right"))
				{
					d = 4;
				}
				else if (keyPressed === 3|| me.input.isKeyPressed("left"))
				{
					d = 1;
				}
				else 
                ...
                if (PREFS.PLAYER_USES_TELEPORT.value && "undefined" !== typeof game.data.teleportArray) {
                    ...
                    if (0 !== h) {
                        var k = Math.abs(32 * Math.floor((this.pos.x + 16) / 32) - this.pos.x),
                ...
                0 !== h && ("pill" === h.name ? (game.data.playerIsHunter = !0, game.data.hunterTimer = me.timer.getTime() + PREFS.POWER_UP_DURATION.value, game.data.score += PREFS.PILL_POINTS.value, 0 < PREFS.PILL_ANIMATION_PICKUP.value.length ? h.setCurrentAnimation("pick", function() {
                    ...
                    (me.game.world.removeChild(h), removeFromRadar(h)), PREFS.AUDIOENABLED.value && me.audio.play("powerup")) : (game.data.score += PREFS.DOT_POINTS.value, 0 < PREFS.DOT_ANIMATION_PICKUP.value.length ? h.setCurrentAnimation("pick", function() {
                    me.game.world.removeChild(h);
                    removeFromRadar(h);
                    return !1
                ...
                null != game.data.Dots_Layer &&
                    null != game.data.Dots_Layer.getTileId(this.pos.x + 16, this.pos.y + 16) && (game.data.dotCounter -= 1, game.data.score += PREFS.DOT_POINTS.value, game.data.Dots_Layer.clearTile(Math.floor((this.pos.x + 16) / 32), Math.floor((this.pos.y + 16) / 32)), PREFS.AUDIOENABLED.value && me.audio.play("dot"), 0 === game.data.dotCounter && (this.state = "done"));
                game.data.playerIsHunter && (game.data.hunterTimer - me.timer.getTime() < PREFS.ENDING_POWER_UP_ALERT.value ? this.mode = "_power_down" : this.mode = "_hunter", game.data.hunterTimer < me.timer.getTime() &&
                    (game.data.playerIsHunter = !1, this.mode = "", PREFS.AUDIOENABLED.value && me.audio.play("powerdown")));
                ...
                break;
            case "die":
                game.data.running = !1, this.body.vel.x = 0, this.body.vel.y = 0, this.renderable.isCurrentAnimation("die") || this.renderable.setCurrentAnimation("die"), PREFS.MUSICENABLED.value && PREFS.AUDIOENABLED.value && me.audio.stopTrack("soundtrack");
				
				if(0 < game.data.lives)
				{
					
					if (iTimerFinished === true)
					{
						bDoOnceDeath = false;
						window.clearTimeout();
						this.pos.x = 480;
					...
					else
					{
						...
						{
							bDoOnceDeath = true;
							window.setTimeout(function() {iTimerFinished = true;}, 3000);
						}
				...
				else
				{
					if (!bDoOnceGameover)
					{
						bDoOnceGameover = true;
						window.setTimeout(function(){me.state.change(me.state.GAMEOVER)}, 3000);
					}
				}
				//this.state = "wait"; game.data.lives -= 1;
...
var levelText = me.GUI_Object.extend({
	    init: function(a, b, d, e) {
            ...
            this._super(me.GUI_Object, "init", [a - d.framewidth / 2, b - d.frameheight /
                2, d
            ]);
        },
        draw: function(a) {
...
var debug = me.Renderable.extend({
    ...
    arrows = me.Renderable.extend({
        init: function(a) {
            ...
            this.centerV = game.data.real_heightGame /
        ...
        draw: function(a) {
            if (this.self.direction != this.self.wantedDirection) switch (this.self.wantedDirection) {
                ...
                case 4:
                    ...
                    break;
                case 2:
                    a.drawImage(this.image, 2 * this.sprite_size, 0, this.sprite_size, this.sprite_size, this.centerH,
                        this.basso, this.sprite_size, this.sprite_size);
                    break;
                case 1:
    ...
    butt_home_pause = me.GUI_Object.extend({
        ...
        onClick: function() {
            ...
            PREFS.AUDIOENABLED.value && me.audio.stopTrack("soundtrack");
			me.state.change(me.state.MENU);
            return !0
        }
    }),
...
var tutorialScreen = me.GUI_Object.extend({
	init: function(a, b, d) {
            d = {};
            this.image = me.loader.getImage("instructions_img");
            d.image = this.image;
            d.framewidth = this.image.width;
            d.frameheight = this.image.height;
            this.x = a - d.framewidth / 2;
        ...
        onClick: function() {
			//PREFS.AUDIOENABLED.value && me.audio.play("click"),
			//PREFS.AUDIOENABLED.value && me.audio.stopTrack("menu"), 
			//game.data.level = 1,
...
var tutorialButton = me.GUI_Object.extend({
	      init: function(a, b, d) {
            d = {};
            this.image = me.loader.getImage("tutorial_play_button");
            d.image = this.image;
            d.framewidth = this.image.width;
            d.frameheight = this.image.height;
            this.x = a - d.framewidth / 2;
...
game.HUD.Container = me.Container.extend({
    init: function() {
        ...
        "upper" === PREFS.HUD_POSITION.value ? (this.addChild(new game.HUD.ScoreItem(this.w - 10, 20), Infinity), this.addChild(new game.HUD.LivesItem_graphic(10, 10), Infinity), PREFS.PAUSE_BUTTON.value && this.addChild(new game.HUD.butt_pause(this.w / 2, 16), Infinity), this.addChild(new game.HUD.TextItem,
...
game.HUD.RadarItem = me.Renderable.extend({
    ...
    draw: function(a) {
        ...
        for (var b = 0; b < game.data.radarEntities.length; b++) {
            var d = this.x + Math.floor(game.data.radarEntities[b].pos.x / (32 / this.radarUnitSize)),
                e = this.y + Math.floor(game.data.radarEntities[b].pos.y / (32 / this.radarUnitSize));
            if ("player" == game.data.radarEntities[b].name) var f = 2 * this.block_size,
                g = 0;
            "dot" == game.data.radarEntities[b].name &&
                (f = 3 * this.block_size, g = 0);
...
game.HUD.ScoreItem = me.Renderable.extend({
    init: function(a, b) {
        this._super(me.Renderable, "init", [a, b, 120, 120]);
...
game.HUD.LivesItem_graphic = me.Renderable.extend({
    init: function(a, b) {
        this._super(me.Renderable, "init", [a, b, 40, 40]);
        this.lives = -1;
        this.floating = !0;
        this.image = me.loader.getImage("head")
    },
    ...
    draw: function(a) {
        for (var b = 0; b < game.data.lives; b++) a.drawImage(this.image, 10 + b * this.image.width, 10)
    }
});
game.HUD.TextItem = me.Renderable.extend({
    ...
    draw: function(a) {
        "getready" == game.data.text && (b = me.device.isMobile ? game.data.locale.start_mobile : game.data.locale.start_desktop, drawText(a, b, me.game.viewport.width / 2, me.game.viewport.height / 2 + 100, 460, this.font2.font, this.font2.shadow));
        if ("pause" ==
            game.data.text) {
...
game.EnemyEntity = me.Entity.extend({
    init: function(a, b, d) {
        ...
        this.renderable.addAnimation("up", PREFS.ENEMY_ANIMATION_NORMAL_UP_WALK.value,
            60);
        ...
        this.renderable.addAnimation("right_attack", PREFS.ENEMY_ANIMATION_ATTACK_RIGHT_WALK.value,
            60);
        ...
        this.renderable.addAnimation("up_scared", PREFS.ENEMY_ANIMATION_SCARED_UP_WALK.value,
            60);
        ...
        this.renderable.addAnimation("right_transition",
            PREFS.ENEMY_ANIMATION_ENDING_RIGHT_WALK.value, 60);
        ...
        this.body.gravity = 0;
        this.body.setVelocity(999, 999);
        this.alwaysUpdate = null != d.keepAlive ? d.keepAlive : !1;
        this.directions = [8, 4, 2, 1];
    ...
    update: function(a) {
        switch (this.state) {
            case "idle":
                this.respawnTimer < me.timer.getTime() && (0 < PREFS.ENEMY_ANIMATION_RESPAWN.value.length ?
            ...
            case "running":
                if (game.data.running) {
                    ...
                    var b = 0,
                        d = getTile(this);
                    if (this.aiTimer < me.timer.getTime() || 0 == this.body.vel.x &&
                        0 == this.body.vel.y)
                        ...
                        else if (0.5 < Math.random() ? ((this.pos.y + 16) / 32 > (game.data.player.pos.y + 16) / 32 && (b = 8), (this.pos.y + 16) / 32 < (game.data.player.pos.y + 16) / 32 && (b = 2)) : ((this.pos.x + 16) / 32 > (game.data.player.pos.x + 16) / 32 && (b = 1), (this.pos.x + 16) / 32 < (game.data.player.pos.x + 16) / 32 &&
                            (b = 4)), 0 == (b & d) && 0 == this.body.vel.x && 0 == this.body.vel.y)
                        for (b = this.directions[Math.floor(4 * Math.random())]; 0 == (b & d) && 0 != d;) b = this.directions[Math.floor(4 * Math.random())];
                    ...
                    //getAheadCollisionArray(this) == game.data.PLAYER_OBJECT ? this.attack || game.data.playerIsHunter || (this.attack = !0, PREFS.AUDIOENABLED.value && me.audio.play("growl"), this.mode = "_attack", this.renderable.isCurrentAnimation("up") &&
                    //    this.renderable.setCurrentAnimation("up_attack"), this.renderable.isCurrentAnimation("down") && this.renderable.setCurrentAnimation("down_attack"), this.renderable.isCurrentAnimation("left") && this.renderable.setCurrentAnimation("left_attack"), this.renderable.isCurrentAnimation("right") && this.renderable.setCurrentAnimation("right_attack")) :  this.attack = !1;
                    this.renderable.isCurrentAnimation("up") && this.renderable.setCurrentAnimation("up_attack"),
					this.renderable.isCurrentAnimation("down") && this.renderable.setCurrentAnimation("down_attack"),
					this.renderable.isCurrentAnimation("left") && this.renderable.setCurrentAnimation("left_attack"),
					this.renderable.isCurrentAnimation("right") && this.renderable.setCurrentAnimation("right_attack");
					
					entityManager(this, b);
                    if (this.isCollidingWithPlayer && 20 > this.pos.distance(game.data.player.pos))
                        if (game.data.playerIsHunter && PREFS.POWER_UP_INVULNERABILITY.value) {
                            if (PREFS.POWER_UP_KILLS_ENEMIES.value) {
                                game.data.score +=
                                    PREFS.ENEMY_POINTS.value;
                                me.game.world.addChild(new game.EnemyPointsEntity(this.pos.x, this.pos.y, "OMG!NO!"), 999);
                                if (0 < PREFS.ENEMY_ANIMATION_DYING.value.length) this.renderable.setCurrentAnimation("die", function() {
                                    ...
                                    return !1
                                }.bind(this)), this.renderable.setAnimationFrame(0), this.state = "donothing";
                                else if ("respawn" === PREFS.ON_DEAD_ENEMY_ACTION.value) switch (this.pos.x = this.initialX, this.pos.y = this.initialY,
                                    this.respawnTimer = me.timer.getTime() + PREFS.ENEMY_RESPAWN_TIME.value, this.body.vel.x = 0, this.body.vel.y = 0, this.state = "running", this.mode = "", this.renderable.alpha = 1, this.direction = this.initialDirection, this.direction) {
                                    case 8:
                                        this.renderable.setCurrentAnimation("up");
                                        break;
                                    case 4:
                                ...
                                PREFS.AUDIOENABLED.value &&
                                    me.audio.play("killenemy")
                            }
                        } else
						{
							(this.renderable.isCurrentAnimation("up") || this.renderable.isCurrentAnimation("up_attack")) && this.renderable.setCurrentAnimation("up_bite"), (this.renderable.isCurrentAnimation("down") || this.renderable.isCurrentAnimation("down_attack")) && this.renderable.setCurrentAnimation("down_bite"), (this.renderable.isCurrentAnimation("left") || this.renderable.isCurrentAnimation("left_attack")) && this.renderable.setCurrentAnimation("left_bite"), (this.renderable.isCurrentAnimation("right") ||
                            this.renderable.isCurrentAnimation("right_attack")) && this.renderable.setCurrentAnimation("right_bite"), PREFS.AUDIOENABLED.value && me.audio.play("dead"), game.data.player.state = "die";
				...
				{
					window.setTimeout(function(){this.pos.x = this.initialX;
					this.pos.y = this.initialY;}.bind(this), 3000);
					this.body.vel.x = 0, this.body.vel.y = 0
				}
        }
        this._super(me.Entity, "update", [a]);
...
function addToTeleportArray(a) {
    ...
    game.data.teleportArray[Math.floor((a.pos.x + 16) / 32)][Math.floor((a.pos.y + 16) /
        32)] = a;
...
game.MenuSprite = me.Entity.extend({
		init: function(a, b) {
            settings = {};
            settings.image = me.loader.getImage("gui_bg");
			...
			this.renderable.addAnimation("gui_bg", PREFS.BACKGROUND_GNASHER_MAIN_MENU_TEST.value, 120);
			this.renderable.setCurrentAnimation("gui_bg");
		}
});
...
game.MenuScreen = me.ScreenObject.extend({
    onResetEvent: function() {
		...
		var sprite = new game.MenuSprite(this.w /2, this.h/2);
		//var sprite = new me.Sprite(this.w / 2, this.h / 2, {
        //    image: a,
		//	framewidth: 320,
		//	frameheight: 480,
        //});
		//this.renderable.addAnimation("gui_bg", PREFS.BACKGROUND_GNASHER_MAIN_MENU.value, 60);
		//this.renderable.setCurrentAnimation("gui_bg");
		//sprite.renderable.addAnimation("gui_bg", PREFS.BACKGROUND_GNASHER_MAIN_MENU.value, 60);
		//sprite.renderable.setCurrentAnimation("gui_bg");
		
        this.background = sprite
		
		//this.background.addAnimation("gui_bg", PREFS.BACKGROUND_GNASHER_MAIN_MENU.value, 60);
		//this.background.setCurrentAnimation("gui_bg");
        me.game.world.addChild(this.background, 1);
        this.background.draw(me.video.renderer);
        this.maintitle_instance = new maintitle(0.5 * this.w, 0.22 * this.h);
...
game.HowToPlayScreen = me.ScreenObject.extend({
    onResetEvent: function() {
        this.w = me.video.renderer.getWidth();
        this.h = me.video.renderer.getHeight();
        var a = me.loader.getImage("gui_bg_still");
...
game.ChooseScreen = me.ScreenObject.extend({
    onResetEvent: function() {
        ...
        me.game.world.addChild(new button_levels_up(this.w /2, 40), 4);
        ...
        for (var g = 1, l = 0; l < f; l++)
            for (var h = 1; h <= e && !(g <= b ? me.game.world.addChild(new button_level(0 + this.w / (e + 1) * h, game.data.spazioTop + game.data.spacing * l, g, !1), 99) : me.game.world.addChild(new button_level(0 + this.w / (e + 1) * h, game.data.spazioTop + game.data.spacing * l, g, !0), 99), g++, g > a); h++);
    }
});
var button_level = me.GUI_Object.extend({
        ...
        onClick: function() {
			...
			if(bTutorialOpen === false)
			{
				if (this.level === 1)
				{
					me.game.world.addChild(new tutorialScreen (160,240,0), 100);
					bTutorialOpen = true;
					me.game.world.addChild(new tutorialButton (240,450,0), 101);
				}
				else
				{
					...
					//(PREFS.AUDIOENABLED.value && me.audio.play("click"), PREFS.AUDIOENABLED.value && me.audio.stopTrack("menu"), game.data.level = this.level, me.state.change(me.state.PLAY));
					return !0
				}
			}
        }
    ...
    button_levels_up = me.GUI_Object.extend({
        init: function(a, b) {
            settings = {};
            settings.image = me.loader.getImage("level_select_text");
            settings.spritewidth = 320;
    ...
    onResetEvent: function() {
        ...
        me.game.world.addChild(new(me.Renderable.extend({
            ...
            draw: function(a) {
                ...
                drawText(a, d, me.game.viewport.width / 2 + 50, me.game.viewport.height / 2.5, game.data.widthGame, this.font2.font, this.font2.shadow);
                drawText(a, game.data.score.toString(), me.game.viewport.width / 2 + 50, me.game.viewport.height / 2.5 + 40, game.data.widthGame, this.font.font, this.font.shadow)
            }
        })), 20);
        var a = 120;
		...
		me.game.world.addChild(new lose_bg(this.w /2, this.h/2, 0));
    }
});
var butt_main_menu = generic_big_button.extend({
	...
	lose_bg = me.GUI_Object.extend({
        init: function(a, b, d) {
            d = {};
            this.image = me.loader.getImage("mission_failed");
            d.image = this.image;
            d.framewidth = this.image.width;
            d.frameheight = this.image.height;
            this.x = a - d.framewidth / 2;
...
game.YouDidItScreen = me.ScreenObject.extend({
    onResetEvent: function() {
		...
		if (game.data.level === 16)
		{
			this.overlay = new me.ColorLayer("overlay", new me.Color(0, 0, 0, 0.3), 0);
			//me.game.world.addChild(this.overlay, -999);
			me.game.world.addChild(new menu_home(this.w / 2, this.h / 2 +200), 40);
			me.game.world.addChild(new menu_win_bg(this.w /2, this.h/2, 40));
			me.game.world.addChild(new menu_win_title(this.w /2, this.h/2 - 120, 0));	
			//me.game.world.addChild(new menu_restart(this.w / 2, this.h / 2 - 20), 40);
			//me.game.world.addChild(new menu_continue(this.w / 2 + 30, this.h / 2 +200), 40);
		...
		else
		{
			this.overlay = new me.ColorLayer("overlay", new me.Color(0, 0, 0, 0.3), 0);
			//me.game.world.addChild(this.overlay, -999);
			me.game.world.addChild(new menu_home(this.w / 2 + 30, this.h / 2 - 20), 40);
			me.game.world.addChild(new menu_bg(this.w /2, this.h/2, 0));
			//me.game.world.addChild(new menu_restart(this.w / 2, this.h / 2 - 20), 40);
			me.game.world.addChild(new menu_continue(this.w / 2 + 90, this.h / 2 - 20), 40);
			this.youdidit = new(me.Renderable.extend({
				init: function() {
					this._super(me.Renderable, "init", [0, 0, 100, 100]);
					this.font = prepareFont(30);
...
var menu_home = me.GUI_Object.extend({
	...
	menu_win_bg = me.Entity.extend({
        init: function(a, b) {
            settings = {};
            settings.image = me.loader.getImage("mission_16_win");
            settings.spritewidth = 320;
            settings.spriteheight = 480;
			settings.framewidth = 320;
			settings.frameheight = 480;
            ...
            settings.height = settings.spriteheight;
            this._super(me.Entity, "init", [0, 0, settings]);
			this.renderable.addAnimation("mission_16_win", PREFS.BACKGROUND_GNASHER_MAIN_MENU_TEST.value, 120);
			this.renderable.setCurrentAnimation("mission_16_win");
        }
    }),
	menu_win_title = me.GUI_Object.extend({
        init: function(a, b, d) {
            d = {};
            this.image = me.loader.getImage("win_screen_16_title");
            d.image = this.image;
            d.framewidth = this.image.width;
            d.frameheight = this.image.height;
            this.x = a - d.framewidth / 2;
	...
	menu_bg = me.GUI_Object.extend({
        init: function(a, b, d) {
            d = {};
            this.image = me.loader.getImage("mission_win");
            d.image = this.image;
            d.framewidth = this.image.width;
            d.frameheight = this.image.height;
            this.x = a - d.framewidth / 2;
    ...
    menu_restart = me.GUI_Object.extend({
        ...
        onClick: function() {
            PREFS.AUDIOENABLED.value && me.audio.play("click");
            navigator.isCocoonJS ? me.state.change(me.state.USER + 6) : me.state.change(me.state.PLAY);
            return !0
        }
    }),
    ...
    onResetEvent: function() {
			...
			if (null != game.data.Dots_Layer)
				for (var a = game.data.Path_Layer.cols, b = game.data.Path_Layer.rows, d = 0; d < a; d++)
					for (var e = 0; e < b; e++) null != game.data.Dots_Layer.getTileId(32 * d + 16, 32 * e + 16) && (game.data.dotCounter += 1)
    },
    onDestroyEvent: function() {
        me.sys.fps = 60;
