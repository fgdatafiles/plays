(function() {
    ...
    var p = c.extend(Slot9, c.Container);
    p._active = false;
    p.initialize = function() {
        console.log('Slot9 int');
        ...
        this.shape.graphics.f("rgba(255,0,0,0.51)").s().p("AlKK9IgDAAQhJAMgmiqQgjidAGj6QAGj7AtjhQAwj3BOh4QEFiwFFCNQDGB5geDdIAGAAQAbHrgnHfQgtgLgPAcQgaB+AmBdIgDAAg");
        this.shape.setTransform(0, 0); //47.687,80.6469);
        this.shape.alpha = .8;
    ...
    window.Slot9 = c.promote(Slot9, "Container");
