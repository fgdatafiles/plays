...
d.value*e;e=Math.min(1,e+g)}};this.dataURItoBlob=function(dataURI){var byteString,mimestring;if(dataURI.split(",")[0].indexOf("base64")!==-1)byteString=atob(dataURI.split(",")[1]);else byteString=decodeURI(dataURI.split(",")[1]);mimestring=dataURI.split(",")[0].split(":")[1].split(";")[0];var content=new Array;for(var i=0;i<byteString.length;i++)content[i]=
byteString.charCodeAt(i);return new Blob([new Uint8Array(content)],{type:mimestring})};this.ordinal_suffix_of=function(a){var b=a%10;a%=100;return 1==b&&11!=a?"st":2==b&&12!=a?"nd":3==b&&13!=a?"rd":"th"};this.doFader=function(){fader.style.display="inline-block";fader.style.opacity=1;
...
c.childNodes[0].nodeValue:"";oLANG[f.id]=f}if(a=a.getElementsByTagName("img"))for(d=0;d<a.length;d++)c=a[d],b=c.getAttribute("id"),oLANG_IMAGES[b]=c.childNodes[0].nodeValue;!platform.isIE&&support.canvas&&support.webgl&&support.clamped_array?doInit():doBrowserAlert()}};e.send(null)}
