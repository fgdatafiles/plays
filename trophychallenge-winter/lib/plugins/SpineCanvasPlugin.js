    ...
    onFileComplete: function (file)
    {
        ...
        if (index !== -1)
        {
            ...
            if (file.type === 'text')
            {
                ...
                //MP Override to allow asset pack loading
                loader.setPath(file.url.substring(0, file.url.lastIndexOf('/')));
...
var SpineGameObjectCanvasRenderer = function (renderer, src, interpolationPercentage, camera, parentMatrix)
{
    ...
    // TODO: MP hack because the context wasn't restored properly.
    context.restore();
    context.save();
