(function() {
    ...
    var p = c.extend(Slot30, c.Container);
    p._active = false;
    p.initialize = function() {
        console.log('Slot30 int');
        ...
        this.shape.graphics.f("#FF0000").s().p("AwzPjIAA+yIH4gTIZvB/QnVAehgH1QgxKkAFKPg");
    ...
    window.Slot30 = c.promote(Slot30, "Container");
}());