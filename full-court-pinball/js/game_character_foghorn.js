...
var GameFoghorn= function(){
	...
	this.doInit = function(){
		...
		//3d items
		character = GAME.table.getObjectByName("popup_foghorn");

		//targets
		target = oTABLE.items.foghorn;
		target.setUserData({hit_callback:me.doHit});
		
		switch_show = oTABLE.items.foghorn_show;
		switch_show.setUserData({enter_callback : me.doShow});
		
		switch_hide = oTABLE.items.foghorn_hide;
