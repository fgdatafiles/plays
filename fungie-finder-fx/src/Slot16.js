(function() {
    ...
    var p = c.extend(Slot16, c.Container);
    p._active = false;
    p.initialize = function() {
        console.log('Slot16 int');
        ...
        this.shape.graphics.f("#FF0000").s().p("ADbNQIAAgDQrzinmWqNIgGgHIBKknICakIIBHAaICHGgIDDlVICUAeICPExICTj7IB+AaIBpFUIDalKQjegTjggkQiPgXiSgdQkRg3kThPIgQgFIAgkgIZxCyIm7X7g");
    ...
    window.Slot16 = c.promote(Slot16, "Container");
}());