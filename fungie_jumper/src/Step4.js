...
(function()
{
    ...
    var player,hud,tPoints,sh,tBestPoints,points,points_flush,hud2,tHeight,bgd2,line;
    var highest;
    var nHeight = 0;
    function Step4()
    {
...
/// HUD1
        ...
        hud.addChild(bgd);
        tPoints  = new c.Text('0', '42px lubalin','#009900');
...
/// HUD2
        ...
        hud2.addChild(bgd2);
        tHeight  = new c.Text('0', '42px lubalin','#663333');
    ...
    function anim(){
        if(!game.gameOver) {
            ...
            game.points[game.nCurrentLevel] = parseInt(tPoints.text);

            playSounds('sBad'+Math.ceil(Math.random()*5));
            t.addChild(sh);
            sh.alpha=0;
    ...
    function disp(){
        ...
        if(game.nCurrentLevel==3&&game.points[3]>=game.levelLimits[3]){
