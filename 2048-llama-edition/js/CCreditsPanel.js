function CCreditsPanel(){
    ...
    this._init = function(){
        ...
        _pStartPosExit = {x: 605 , y: 550};
        _oButExit = new CGfxButton(_pStartPosExit.x, _pStartPosExit.y, oSprite, _oContainer);
        _oButExit.addEventListener(ON_MOUSE_UP, this.unload, this);

        _oMsgText = new createjs.Text(TEXT_CREDITS_DEVELOPED, "44px " + PRIMARY_FONT, "#ab152c");
	...
	_oContainer.addChild(_oMsgText);
        ...
        _oButLogo.y = CANVAS_HEIGHT/2 + 140;
        _oContainer.addChild(_oButLogo);

        _oLink = new createjs.Text("www.codethislab.com", "38px " + PRIMARY_FONT, "#ab152c");
        _oLink.textAlign = "center";
        _oLink.textBaseline = "alphabetic";
	_oLink.x = CANVAS_WIDTH/2;
        _oLink.y = CANVAS_HEIGHT/2 + 220;
