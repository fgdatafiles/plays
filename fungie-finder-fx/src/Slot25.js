(function() {
    ...
    var p = c.extend(Slot25, c.Container);
    p._active = false;
    p.initialize = function() {
        console.log('Slot25 int');
        ...
        this.shape.graphics.f("#FF0000").s().p("AhiHrIg7h6IkjAcIgMhvIAah9IgumrIAXjbIFOgUIAFBjQAsAUANgqIAxAfIATgDIAXAJIAFAAIAlheIB+AFQBxgoBnARIABAAQBWBHggCpQASCpgKDGQgHDUg9C+IlLADg");
    ...
    p.onGetItem = function(e) {
        ...
        points.y = -gfx.image.height * item.scale + 40;
        t.addChild(points);
    ...
    window.Slot25 = c.promote(Slot25, "Container");
}());