function CGame(oData){
	...
	_oBgAttach = new createjs.Container();
        _oBg = createBitmap(s_oSpriteLibrary.getSprite('bg_game_'+_iCurLevel));
    ...
    s_oLevelSettings = new CLevelSettings(oData.ball_speed_per_level,oData.num_ball_per_level);    
