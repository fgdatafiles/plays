function CMain(oData){
    ...
    this._initSounds = function(){
        ...
        aSoundsInfo.push({path: './sounds/',filename:'hit_cow_1',loop:false,volume:1, ingamename: 'hit_cow_1'});
        aSoundsInfo.push({path: './sounds/',filename:'game_over',loop:false,volume:1, ingamename: 'game_over'});
        aSoundsInfo.push({path: './sounds/',filename:'hit_cow_2',loop:false,volume:1, ingamename: 'hit_cow_2'});
        aSoundsInfo.push({path: './sounds/',filename:'hit_dog',loop:false,volume:1, ingamename: 'hit_dog'});
        aSoundsInfo.push({path: './sounds/',filename:'hit_horse',loop:false,volume:1, ingamename: 'hit_horse'});
        aSoundsInfo.push({path: './sounds/',filename:'explosion',loop:false,volume:1, ingamename: 'explosion'});
        aSoundsInfo.push({path: './sounds/',filename:'present',loop:false,volume:1, ingamename: 'present'});
        aSoundsInfo.push({path: './sounds/',filename:'bite',loop:false,volume:1, ingamename: 'bite'});
