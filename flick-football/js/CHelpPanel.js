function CHelpPanel(iXPos, iYPos, oSprite, iPlayerTeam) {
    ...
    this.page1 = function (iPlayerTeam, oContainer) {
		...
		// Power Instructions
		 var oTextPowerStroke;
        oTextPowerStroke = new createjs.Text(TEXT_CLICK_DRAG, "20px " + FONT_GAME, "#ff6000");
        oTextPowerStroke.x = CANVAS_WIDTH * 0.5;
        oTextPowerStroke.y = CANVAS_HEIGHT * 0.5 - 5;
        oTextPowerStroke.textAlign = "center";
        oTextPowerStroke.outline = 5;
        oContainer.addChild(oTextPowerStroke);

        var oTextPower;
        oTextPower = new createjs.Text(TEXT_CLICK_DRAG, "20px " + FONT_GAME, TEXT_COLOR);
        oTextPower.x = CANVAS_WIDTH * 0.5;
        oTextPower.y = oTextPowerStroke.y;
        oTextPower.textAlign = "center";
        oContainer.addChild(oTextPower);

		// Aim Instructions
		 var oTextAimStroke;
        oTextAimStroke = new createjs.Text(TEXT_MOVE_AIM, "20px " + FONT_GAME, "#ff6000");
        oTextAimStroke.x = CANVAS_WIDTH * 0.5;
        oTextAimStroke.y = CANVAS_HEIGHT * 0.5 + 123;
        oTextAimStroke.textAlign = "center";
        oTextAimStroke.outline = 5;
        oContainer.addChild(oTextAimStroke);

        var oTextAim;
        oTextAim = new createjs.Text(TEXT_MOVE_AIM, "20px " + FONT_GAME, TEXT_COLOR);
        oTextAim.x = CANVAS_WIDTH * 0.5;
        oTextAim.y = oTextAimStroke.y;
        oTextAim.textAlign = "center";
        oContainer.addChild(oTextAim);

		// Get the player team sprite - origonal sprite "players"
        oSpriteCharacter = s_oSpriteLibrary.getSprite("players2");
		// 270
        _oPosPower = {x: CANVAS_WIDTH_HALF , y: 295};
