...
(function(){
    ...
    hud.initialize=function() {
       ...
       bgd=  new c.Bitmap(main.loadedData.getResult('hud_bgd'+nCurrentLevel));
        t.addChild(bgd);




        time_txt = new c.Text('0:00', '36px lubalin', '#ff2b46');
        ...
        point_txt = new c.Text('00000', '36px lubalin', '#ffce4b');
