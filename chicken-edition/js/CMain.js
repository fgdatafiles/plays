function CMain(oData) {
    ...
    this._initSounds = function(){
        ...
        aSoundsInfo.push({path: './sounds/',filename:'moving',loop:false,volume:1, ingamename: 'moving'});
        aSoundsInfo.push({path: './sounds/',filename:'great_matching',loop:false,volume:1, ingamename: 'great_matching'});
