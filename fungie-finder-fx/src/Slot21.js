(function() {
    ...
    var p = c.extend(Slot21, c.Container);
    p._active = false;
    p.initialize = function() {
        console.log('Slot21 int');
        ...
        this.shape.graphics.f("#FF0000").s().p("ACSQ5InXiIQA6gLBXx4QiBjfoyBXIAvreIagACMgATAhvg");
    ...
    window.Slot21 = c.promote(Slot21, "Container");
}());