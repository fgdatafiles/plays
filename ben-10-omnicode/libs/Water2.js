...
THREE.Water = function(geometry, options) {
	...
	var normalMap0 = options.normalMap0 || textureLoader.load('./assets/images/Water_1_M_Normal.jpg');
	var normalMap1 = options.normalMap1 || textureLoader.load('./assets/images/Water_2_M_Normal.jpg');
