...
function buildGameCanvas(){
	...
	woodTopLeft.x = woodBottomLeft.x = canvasW/100 * 21-200;
	woodTopRight.x = woodBottomRight.x = canvasW/100 * 79-700;
	woodTopLeft.y = woodTopRight.y =  canvasH/100 * 32 - 100;
	woodBottomLeft.y = woodBottomRight.y =  canvasH/100 * 48-150;
	...
	healthContainer.x = canvasW/100 * 3 - 50;
	funContainer.x = canvasW/100 * 24 - 200;
	xpContainer.x = canvasW/100 * 45 - 350;
	...
	iconSound = new createjs.Bitmap(loader.getResult("iconSoundMute"));
	iconSoundMute = new createjs.Bitmap(loader.getResult("iconSound"));
	centerReg(iconShopnow);
	//centerReg(iconShop);
	centerReg(iconSound);
	centerReg(iconSoundMute);
	
	iconShopnow.x = canvasW/100*67-500;
	iconShopnow.y = 57;
	iconSound.x = iconSoundMute.x = (canvasW/100 * 76) - 550;
	iconSoundMute.x = iconSound.x = (canvasW/100 * 76) - 550;
	iconShop.x = canvasW/100 * 85.5;
	iconShop.y = iconSound.y = iconSoundMute.y = 53;
	
	/*iconFullscreen = new createjs.Bitmap(loader.getResult("iconFullscreen"));
	centerReg(iconFullscreen);
	iconFullscreen.y = 53;
	iconFullscreen.x = canvasW/100 *95;*/
	...
	centerReg(bgPop);
	bgPop.x = canvasW/2-400;
	bgPop.y = canvasH/2-150;
	...
	titleCollection.x = titleFull.x = titleWelcome.x = titleHow.x = titleGameover.x = canvasW/2 - 400;
	titleCollection.y = titleFull.y = titleWelcome.y = titleHow.y = titleGameover.y = canvasH/100*25-150;
	...
	btnReplace.x = btnOk.x = btnBuy.x = btnBuyDisable.x = btnStart.x = canvasW/2-400;
	btnReplace.y = btnOk.y = btnBuy.y = btnBuyDisable.y = btnStart.y = canvasH/100 * 77-200;
	...
	centerReg(btnLeft);
	centerReg(btnRight);
	btnLeft.x = canvasW/100 * 25 - 180; // Change left and right button position
	btnRight.x = canvasW/100 * 75-600;
	btnRight.scaleX = -1;
	btnLeft.y = btnRight.y = canvasH/2;
	
	btnClose.x = canvasW/100 * 73-600;
	btnClose.y = canvasH/100*25-25;
	...
	conHow1.x = conHow2.x = conHow3.x = conHow4.x = conDead.x = canvasW/2 - 400;
	conHow1.y = conHow2.y = conHow3.y = conHow4.y = conDead.y = canvasH/2-150;
	...
	conText.x = canvasW/2-400;
	conText.y = (canvasH/100 * 30)+txtExtra;
	
	logo.x = canvasW/100 * 70 -1100;
	logo.y = canvasH/100 * 40 - 300;
	btnBegin.x = canvasW/100 * 72 - 1100;
	btnBegin.y = canvasH/100 * 63 - 400;
