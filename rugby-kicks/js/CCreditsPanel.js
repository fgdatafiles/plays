function CCreditsPanel(){
    ...
    this._init = function(){
        ...
        oTitle.y = -oSprite.height/2 + 60;
        oTitle.textAlign = "center";
        oTitle.textBaseline = "middle";
        oTitle.lineWidth = 300;
        _oPanelContainer.addChild(oTitle);

        var oLink = new createjs.Text("www.codethislab.com"," 20px "+PRIMARY_FONT, "#ffffff");
        oLink.y = 70;
        ...
        _oButExit = new CGfxButton(193, -90, oSprite, _oPanelContainer);
