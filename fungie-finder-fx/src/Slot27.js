(function() {
    ...
    var p = c.extend(Slot27, c.Container);
    p._active = false;
    p.initialize = function() {
        console.log('Slot27 int');
        ...
        this.shape.graphics.f("#FF0000").s().p("Am4HmIAjjKIgOo5IDGgKQAph5gGhnIB6AFIAFBIQAhAvA7gJIAhgWIAjAkQAMghACgmQACgXgCgoIDoAMQBlApgIBqIgXFfQAKD+gTDoIg5gBIgzAfQjbgfjqAhQhaAVhCAAQhZAAgqgng");
    ...
    window.Slot27 = c.promote(Slot27, "Container");
}());