	    ...
	    function Game() {
	        ...
	        var _this = (0, _possibleConstructorReturn3.default)(this, (Game.__proto__ || (0, _getPrototypeOf2.default)(Game)).call(this, 1920, 1080, Phaser.CANVAS, "game_container", {
	            preload: function preload() {
	                ...
	                this.game.load.baseURL =  true ? './' : window.game_config.base_assets_url;
	            },
	...
	var _class = function (_Phaser$State) {
	  ...
	  (0, _createClass3.default)(_class, [{
	    ...
	    value: function create() {
	      ...
	      // hero
	      this.hero = new _Hero2.default(this.game, this.game.width / 2, this.game.height * 0.7);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _class = function (_Phaser$Sprite) {
	  ...
	  function _class(game, x, y, asset) {
	    ...
	    _this.pointer = _this.game.make.sprite(-40, 55, "hero_arm");
	    _this.pointer.anchor.set(0.09, 0.5);
	  ...
	  (0, _createClass3.default)(_class, [{
	    ...
	    value: function aim(angle) {
	      ...
	      this.costume.frameName = "hero00" + frame;
	    }
	  }, {
