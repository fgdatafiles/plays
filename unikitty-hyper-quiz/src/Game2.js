...
(function()
{
    ...
    var game;
    var timer;
    var pos=[[39,71],[165,71],[290,71],[39,197],[165,197],[290,197],[39,323],[165,323],[290,323]];
    ...
    game2.init = function(){
        ...
        shuffle(arr);
        shuffle(pos);
        if(app.game2.length<1){
            app.game2 = globals.strings.pages.game2.images;
        }
        currData =  app.game2.shift();
      //  $.cookie(app.prefix+"_"+app.country+"_game2",app.game2);
        nCorrect =parseInt(currData.id);
            
        bgd=new c.Bitmap(main.loadedData.getResult('game2_bgd'));
        t.addChild(bgd);
        ...
        cc.addChild(bgd);
        var question  = new c.Text(  globals.strings.pages.game2.intro.text, globals.strings.pages.game2.intro.font,'#0449C3');

        var l = question.font;
        l =l.substr(0,l.indexOf('px'));
        question.textAlign= 'center';
        question.lineWidth = 344;
        question.x =globals.strings.pages.game2.intro.x+179+question.lineWidth/2;
        question.y =globals.strings.pages.game2.intro.y+getoffset(question.font)+229/2-question.getMeasuredHeight()/2-(l/10);
        ...
        TweenLite.from(cc,.5,{scaleX:0,scaleY:0,delay:.7,ease:Power2.easeOut});
    ...
    function onNext(e){
        ...
        question.x =globals.strings.pages.game2.intro.x+14+question.lineWidth/2;
        question.y =globals.strings.pages.game2.intro.y+getoffset(question.font)+99/2-question.getMeasuredHeight()/2-(l/10);
        question.textBaseline = 'alphabetic';
        cc.addChild(question);

        bgd =new c.Bitmap(main.loadedData.getResult('game2_ch'+currData.id));
        ...
        for(var i=0;i<9;i++){
            ...
            var b =new createjs.Bitmap(main.loadedData.getResult('game2_bgd_idle'));
            piece.addChild(b);
            b =new createjs.Bitmap(main.loadedData.getResult('game2_'+nCorrect+'_'+z));
            piece.addChild(b);
            b.x =57-b.image.width/2;
            b.y =57-b.image.height/2;
            piece.addChild(b);
    ...
    function onCheckMe(e){
        ...
        bgd =new c.Bitmap(main.loadedData.getResult('game2_ch'+currData.id+'_good'));
