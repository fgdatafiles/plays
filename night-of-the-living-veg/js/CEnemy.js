...
//---------------------------------------------
    ...
    this._init = function (iXPos, iYPos, iType, iRow, iCol, iIndex) {
        ...
        var oData = {
            ...
            frames: {width: oSpriteEnemyBottom.width / 8, height: oSpriteEnemyBottom.height / 3, regX: (oSpriteEnemyBottom.width / 2) / 8 + ENEMY_OFFSET_REG[_iType].x, regY: (oSpriteEnemyBottom.height / 2) / 3 + ENEMY_OFFSET_REG[_iType].y},
        ...
        _oEnemyBottom = createSprite(oSpriteSheetHeroBottom, 0, ((oSpriteEnemyBottom.width / 2) / 8) + ENEMY_OFFSET_REG[_iType].x, ((oSpriteEnemyBottom.height / 2) / 3) + ENEMY_OFFSET_REG[_iType].y, oSpriteEnemyBottom.width / 8, oSpriteEnemyBottom.height / 3);
        _oEnemyBottom.stop();
        this.createEnemyTop();
    ...
    this.createEnemyTop = function () {
        ...
        var oData = {
            ...
            // width, height & registration point of each sprite
            frames: {width: oSpriteEnemyTop.width / 8, height: oSpriteEnemyTop.height / 3, regX: (oSpriteEnemyTop.width / 2) / 8 + ENEMY_OFFSET_REG[_iType].x, regY: (oSpriteEnemyTop.height / 2) / 3 + ENEMY_OFFSET_REG[_iType].y},
            animations: {walk: [0, 7, "walk", 0.5], escape: [8, 15, "attack", 0.5], die: [16, 23, "die", 0.5]}
        };
        var oSpriteSheetHeroTop = new createjs.SpriteSheet(oData);

        _oEnemyTop = createSprite(oSpriteSheetHeroTop, 0, ((oSpriteEnemyTop.width / 2) / 8) + ENEMY_OFFSET_REG[_iType].x, ((oSpriteEnemyTop.height / 2) / 3) + ENEMY_OFFSET_REG[_iType].y, oSpriteEnemyTop.width / 8, oSpriteEnemyTop.height / 3);
    };
    ...
    this.createEnemyLeftRight = function () {
        ...
        var oData = {
            ...
            // width, height & registration point of each sprite
            frames: {width: oSpriteEnemyLeftRight.width / 8, height: oSpriteEnemyLeftRight.height / 3, regX: (oSpriteEnemyLeftRight.width / 2) / 8 + ENEMY_OFFSET_REG[_iType].x, regY: (oSpriteEnemyLeftRight.height / 2) / 3 + ENEMY_OFFSET_REG[_iType].y},
            animations: {walk: [0, 7, "walk", 0.5], escape: [8, 15, "attack", 0.5], die: [16, 23, "die", 0.5]}
        };
        var oSpriteSheetHeroLeftRight = new createjs.SpriteSheet(oData);

        _oEnemyLeftRight = createSprite(oSpriteSheetHeroLeftRight, 0, ((oSpriteEnemyLeftRight.width / 2) / 8) + ENEMY_OFFSET_REG[_iType].x, ((oSpriteEnemyLeftRight.height / 2) / 3) + ENEMY_OFFSET_REG[_iType].y, oSpriteEnemyLeftRight.width / 8, oSpriteEnemyLeftRight.height / 3);
