...
var items_arr = [{icon:'assets/icons/ball.png', item:'assets/items/ball.png', name:'ball', type:'toy', follow:false, shadow:.5, objY:0, front:true, health:0, fun:5, xpBuy:100, xp:15, shop:false},
				{icon:'assets/icons/bubble.png', item:'assets/items/bubble.png',name:'bubble', type:'toy', follow:true, shadow:.8, objY:0, front:true, health:0, fun:8, xpBuy:100, xp:15, shop:true},
				{icon:'assets/icons/cat.png', item:'assets/items/cat.png', name:'cat', type:'toy', follow:false, shadow:1, objY:-20, front:false, health:0, fun:10, xpBuy:150, xp:30, shop:true},
				{icon:'assets/icons/comb.png', item:'assets/items/comb.png', name:'comb', type:'toy', follow:true, shadow:1, objY:0, front:true, health:0, fun:5, xpBuy:100, xp:15, shop:true},
				{icon:'assets/icons/rubberduck.png', item:'assets/items/rubberduck.png', name:'rubberduck', type:'toy', follow:false, shadow:.8, objY:0, front:true, health:0, fun:10, xpBuy:200, xp:6, shop:true},
				{icon:'assets/icons/spacesuit.png', item:'assets/items/spacesuit.png', name:'spacesuit', type:'toy', follow:false, shadow:1, objY:0, front:true, health:0, fun:5, xpBuy:300, xp:30, shop:true},
				{icon:'assets/icons/donut.png', item:'assets/items/donut.png', name:'donut', type:'food', follow:true, shadow:.6, objY:0, front:true, health:5, fun:0, xpBuy:100, xp:3, shop:true},
				{icon:'assets/icons/hotdog.png', item:'assets/items/hotdog.png', name:'hotdog', type:'food', follow:true, shadow:.8, objY:0, front:true, health:10, fun:0, xpBuy:100, xp:3, shop:true},
				{icon:'assets/icons/noodle.png', item:'assets/items/noodle.png', name:'noodle', type:'food', follow:true, shadow:.7, objY:0, front:true, health:25, fun:0, xpBuy:200, xp:3, shop:true},
				{icon:'assets/icons/chili.png', item:'assets/items/chili.png', name:'chili', type:'food', follow:true, shadow:.8, objY:0, front:true, health:-20, fun:10, xpBuy:180, xp:30, shop:true},
				{icon:'assets/icons/coffee.png', item:'assets/items/coffee.png', name:'beans', type:'food', follow:true, shadow:.5, objY:0, front:true, health:20, fun:0, xpBuy:100, xp:3, shop:true},
				{icon:'assets/icons/icecream.png', item:'assets/items/icecream.png', name:'icecream', type:'food', follow:true, shadow:.5, objY:0, front:true, health:10, fun:0, xpBuy:100, xp:3, shop:true},
				{icon:'assets/icons/steak.png', item:'assets/items/steak.png', name:'steak', type:'food', follow:true, shadow:.9, objY:0, front:true, health:30, fun:0, xpBuy:300, xp:3, shop:true}];
	...
	if(foodSelected == null){
		switch(con){
			...
			case 'move':
				...
				if((obj.stageY) + obj.target.offset.y < objGround - ((obj.target.image.naturalHeight-obj.target.regY) - obj.target.objY))
...
function updateItemsAction(){
	if(foodSelected != null){
		var pointPuki = curPukiAnimation.globalToLocal(foodSelected.x, foodSelected.y);
	...
	if(toySelected != null){
		...
		if(toySelected.name == 'bubble' && toySelected.selected){
			if(!pukiGravityActive && !eating) {
				var pointPuki = curPukiAnimation.globalToLocal(toySelected.x, toySelected.y);
				if(bubbleHitTime > 0){
					bubbleHitTime--;	
				}else{
					if(curPukiAnimation.hitTest(pointPuki.x, pointPuki.y)){
