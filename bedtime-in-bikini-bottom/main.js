    ...
    require(['pixi', 'md'], function(pixi, md){
        ...
        require([
           game_base_path+"minifiedjs/game.min.js"
            ...
            initGame(game_base_path, loc, visualAssets,  audioAssets, preloaderLoadingPrefix, ieVersion, retina, deeplink_config_file);
        });
...
function initGame(base_path, loc, visualAssets, audioAssets, preloaderLoadingPrefix, ieVersion, retina){
    ...
    game = new Game(base_path, loc, "game-holder", visualAssets, audioAssets, preloaderLoadingPrefix, ieVersion, retina, deeplink_config_file); //Version (displayed on preloader for debugging), base path, string to get main holder div..

    game.addScene(LoadingScene);
    game.addScene(SpineTestScene);
    game.addScene(TitleScene);
    game.addScene(HelpScene);
    game.addScene(PattyPileUpTitleScene);
    game.addScene(PattyPileUpIntro1Scene);
    game.addScene(PattyPileUpIntro2Scene);
    game.addScene(MeowNoIntro1Scene);
    game.addScene(MeowNoIntro2Scene);
    game.addScene(MeowNoTitleScene);
    game.addScene(GlideToGloryTitleScene);
    game.addScene(GlideToGloryIntro1Scene);
    game.addScene(GlideToGloryIntro2Scene);
    game.addScene(SlapHappyTitleScene);
    game.addScene(SlapHappyIntro1Scene);
    game.addScene(SlapHappyIntro2Scene);
    game.addScene(HubScene);
    game.addScene(PattyPileUpGameplayScene);
    game.addScene(GlideToGloryGameplayScene);
    game.addScene(PattyPileUpEndScene);
    game.addScene(GlideToGloryEndScene);
    game.addScene(SlapHappyGameplayScene);
    game.addScene(SlapHappyEndScene);
    game.addScene(MeowNoEndScene);
    game.addScene(MeowNoGameplayScene);
