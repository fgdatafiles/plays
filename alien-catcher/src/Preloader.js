...
(function(){
    ...
    p.initialize=function()
    {
        ...
        var sounds = [
            ...
            {id:'fail5', src:'sounds/fail5.mp3'},
            {id:'fail6', src:'sounds/fail6.mp3'},
            {id:'show1', src:'sounds/show1.mp3'},
            {id:'show2', src:'sounds/show2.mp3'},

            
            {id:'fail7', src:'sounds/fail7.mp3'},
     ...
     pre_bgd=new createjs.Bitmap('img/preloader/pre_bgd.png');
        pre_bgd.x = (1640/2)-220/2;
        pre_bgd.y = 680/2 - 293/2;
        t.addChild(pre_bgd);

         maska=new createjs.Shape(new createjs.Graphics().beginFill('#94d60a').drawRect(0,0,94,12));
         maska.x = pre_bgd.x +63;
         maska.y =pre_bgd.y+ 266;
        maska.scaleX = 0;
        t.addChild(maska)
