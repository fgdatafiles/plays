(function() {
    ...
    var p = c.extend(Slot26, c.Container);
    p._active = false;
    p.initialize = function() {
        console.log('Slot26 int');
        ...
        this.shape.graphics.f("#FF0000").s().p("Ar0ATIKtAPIgaKrQophIhqpygACRAMIJigZIABAEQAiIzpwCLgAq4jcIAAgFQCml0Glh3IAHH8gABqrEIADAAQCxgCBjBWQghB4ALApQBHArC7gRQBBCAAMBUIpEACg");
    ...
    p.onGetItem = function(e) {
        ...
        points.y = -gfx.image.height * item.scale + 140;
        t.addChild(points);
    ...
    window.Slot26 = c.promote(Slot26, "Container");
}());