...
function initGame(base_path, loc, visualAssets, audioAssets, preloaderLoadingPrefix, ieVersion, retina, deeplink_config_file){
    ...
    game.addScene(TrashTitleScene);
    game.addScene(TrashIntro1Scene);
    game.addScene(GeoRollIntro1Scene);
    game.addScene(GeoRollTitleScene);
    game.addScene(FoodFightTitleScene);
    game.addScene(FoodFightIntro1Scene);
    game.addScene(HubScene);
    game.addScene(FoodFightGameplayScene);
    game.addScene(FoodFightEndScene);
    game.addScene(TrashGameplayScene);
    game.addScene(TrashEndScene);

    game.addScene(LoudLaundryGameplayScene);
    game.addScene(LoudLaundryEndScene);
    game.addScene(LoudLaundryIntro1Scene);
    game.addScene(LoudLaundryTitleScene);

    game.addScene(GeoRollEndScene);
    game.addScene(GeoRollGameplayScene);
