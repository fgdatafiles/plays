...
(function (Utils) {
    var AssetLoader = (function () {
        ...
        AssetLoader.prototype.render = function () {
            ...
            ctx.drawImage(this.oLoaderImgData.img, bX, bY, bWidth, bHeight, canvas.width / 2 - (bWidth / 2) * tempScale, canvas.height / 2 - 70 * tempScale * 1.5 - (bHeight / 2) * tempScale, bWidth * tempScale, bHeight * tempScale);
            ...
            ctx.drawImage(this.oLoaderImgData.img, bX, bY, Math.max((bWidth / this.totalAssets) * this.assetsLoaded, 1), bHeight, canvas.width / 2 - (bWidth / 2) * tempScale, canvas.height / 2 + 110 * tempScale * 1.5 - (bHeight / 2) * tempScale, Math.max((bWidth / this.totalAssets) * this.assetsLoaded, 1) * tempScale, bHeight * tempScale);
            ...
            ctx.drawImage(this.oLoaderImgData.img, bX, bY, bWidth, bHeight, canvas.width / 2 - (bWidth / 2) * tempScale, canvas.height / 2 + 110 * tempScale * 1.5 - (bHeight / 2) * tempScale, bWidth * tempScale, bHeight * tempScale);
        };
        ...
        Panel.prototype.render = function (_butsOnTop) {
            ...
            switch(this.panelType) {
                ...
                case "start":
                    ...
                    ctx.drawImage(this.oUiElementsImgData.img, bX, bY, bWidth, bHeight, -40 - this.posY, canvas.height / 2 - 250 + Math.sin(this.incY / 3) * 10, bWidth, bHeight);
                    ...
                    ctx.drawImage(this.oUiElementsImgData.img, bX, bY, bWidth, bHeight, canvas.width - bWidth + 40 + this.posY, canvas.height / 2 - 210 - Math.sin(this.incY / 3) * 10, bWidth, bHeight);
                    var tempScale = 1;
                    ...
                    ctx.drawImage(this.oUiElementsImgData.img, bX, bY, bWidth, bHeight, canvas.width / 2 - (bWidth / 2) * tempScale, canvas.height * .5 - 230 - this.posY, bWidth * tempScale, bHeight * tempScale);
                    var tempScale = Math.min((canvas.width - 40) / this.oTitleImgData.img.width, 1);
                    ctx.drawImage(this.oTitleImgData.img, 0, 0, this.oTitleImgData.img.width, this.oTitleImgData.img.height, canvas.width / 2 - (this.oTitleImgData.img.width / 2) * tempScale, canvas.height * .5 - (this.oTitleImgData.img.height / 2) * tempScale - this.posY / 2 + 20, this.oTitleImgData.img.width * tempScale, this.oTitleImgData.img.height * tempScale);
                    break;
                case "categorySelect":
                    var oTextDisplayData = {
                        text: "categorySelect",
                ...
                case "game":
                    ...
                    if(canvas.width < canvas.height) {
                        ...
                        var bWidth = this.oUiElementsImgData.oData.oAtlasData[oImageIds.scroll].width;
                        var bHeight = this.oUiElementsImgData.oData.oAtlasData[oImageIds.scroll].height;
                        ctx.drawImage(this.oUiElementsImgData.img, bX, bY, bWidth, bHeight, gridData.x + this.posY - 24, gridData.y - 15, gridData.width * 1.07, gridData.width * 1.07);
                        wordLineHandler.update();
                        wordLineHandler.render();
                ...
                case "gameComplete":
                    ...
                    var bWidth = this.oUiElementsImgData.oData.oAtlasData[oImageIds.char0].width;
                    var bHeight = this.oUiElementsImgData.oData.oAtlasData[oImageIds.char0].height;
                    ctx.drawImage(this.oUiElementsImgData.img, bX, bY, bWidth, bHeight, -80 - this.posY, canvas.height / 2 - 250 + Math.sin(this.incY / 3) * 10, bWidth, bHeight);
                    var bX = this.oUiElementsImgData.oData.oAtlasData[oImageIds.char1].x;
                    var bY = this.oUiElementsImgData.oData.oAtlasData[oImageIds.char1].y;
                    var bWidth = this.oUiElementsImgData.oData.oAtlasData[oImageIds.char1].width;
                    var bHeight = this.oUiElementsImgData.oData.oAtlasData[oImageIds.char1].height;
                    ctx.drawImage(this.oUiElementsImgData.img, bX, bY, bWidth, bHeight, canvas.width - bWidth + 60 + this.posY, canvas.height - 290 - Math.sin(this.incY / 3) * 10, bWidth, bHeight);
                    for(var j = 0; j < 3; j++) {
                        var tempStar = 1;
                        if(tempTime != 0 && tempTime < aStarTimes[2 - j]) {
                            tempStar = 0;
