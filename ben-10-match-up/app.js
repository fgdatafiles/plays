    ...
    var Hud = (function () {
        ...
        Hud.prototype.renderOverlay = function () {
            if(this.rainbowY > 0) {
                ...
                var tempTWidth = getTextWidth(1, 30, "char" + this.cardID) + 50;
                ctx.fillStyle = "#000000";
                ctx.fillRect(canvas.width / 2 - tempTWidth / 2 - 2, (1 - this.rainbowY) * canvas.height + 190 - 2, tempTWidth + 4, 60 + 4);
                ctx.fillStyle = "#FFFFFF";
                ctx.fillRect(canvas.width / 2 - tempTWidth / 2, (1 - this.rainbowY) * canvas.height + 190, tempTWidth, 60);
                addText(1, 30, canvas.width - 40, "center", canvas.width / 2, (1 - this.rainbowY) * canvas.height + 230, "char" + this.cardID, "#000000");
            }
...
(function (Utils) {
    var SaveDataHandler = (function () {
        ...
        SaveDataHandler.prototype.setMuteStatus = function (_audio) {
            this.aLevelStore[1] = _audio;
        };
        SaveDataHandler.prototype.getMuteStatus = function () {
...
var curTime;
var chainCount;
var saveDataHandler = new Utils.SaveDataHandler("ben10matchupcnv1");
var highscore;
var firstRun = true;
var aFallingCards;
...
function updateCreditsScreenEvent() {
    ...
    ctx.fillText("v1.0.4", canvas.width / 2, canvas.height - 20);
