function CCreditsPanel(){
    ...
    this._init = function(){
        ...
        var oTitleBack = new createjs.Text(TEXT_DEVELOPED,"70px "+FONT, "#000");
        oTitleBack.x = oSpriteBg.width/2 + 2;
        oTitleBack.y = oSpriteBg.height/2-98;
        oTitleBack.textAlign = "center";
        oTitleBack.textBaseline = "middle";
        oTitleBack.lineWidth = 600;
        _oPanelContainer.addChild(oTitleBack);
        
        var oTitle = new createjs.Text(TEXT_DEVELOPED,"70px "+FONT, "#ffcc00");
        oTitle.x = oSpriteBg.width/2;
        oTitle.y = oSpriteBg.height/2-100;
        oTitle.textAlign = "center";
        oTitle.textBaseline = "middle";
        oTitle.lineWidth = 600;
        _oPanelContainer.addChild(oTitle);

        var oLinkBack = new createjs.Text("at Beano.com","45px "+FONT, "#000");
        oLinkBack.x = oSpriteBg.width/2 + 2;
        oLinkBack.y = oSpriteBg.height/2+92;
        oLinkBack.textAlign = "center";
        oLinkBack.textBaseline = "middle";
        oLinkBack.lineWidth = 600;
        _oPanelContainer.addChild(oLinkBack);
        
        var oLink = new createjs.Text("at Beano.com","45px "+FONT, "#ffcc00");
        oLink.x = oSpriteBg.width/2;
        oLink.y = oSpriteBg.height/2+90;
    ...
    this._onLogoButRelease = function(){
        window.open("http://www.beano.com/categories/games");
    };
