...
requirejs(["jquery-1.7.1.min", "bodymovin.f84", "gl-matrix-min", "game", "pixi.min", "pixi-particles.min", "pixi-spine", "swfobject", "soundmanager2-nodebug-jsmin"], 
  function($, bodymovinF84, glMatrix, game, pixi, pixiParticles, pixiSpine, swtfObject, soundManager2)
{		
	function gameStart() 		
	{		
