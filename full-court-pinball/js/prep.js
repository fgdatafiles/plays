...
function doLoadLanguage(){
  ...
  http.onreadystatechange = function() {
    ...
    if(http.readyState == 4 && http.status == 200) {
      ...
      var confignodes = root.getElementsByTagName("config");
        if (confignodes) {
          for (var i = 0; i < confignodes.length; i++) {
          var my_node = confignodes[i];
          var my_id = my_node.getAttribute('id');
          var my_value = my_node.childNodes[0].nodeValue;

          if(my_value == "true"){my_value = true;}
      ...
      if(!support.clamped_array){
        browser_ok = false;
      }

      if(platform.isIE11 && oCONFIG.blockIE11){
         browser_ok = false;
       }
      ...
      if(oCONFIG.support_checks){
        if(oCONFIG.support_checks.canvas && !support.canvas){
          browser_ok = false;
        }
        if(oCONFIG.support_checks.webgl && !support.webgl){
          browser_ok = false;
        }
      }
...
var legal_links, legal_images, legal_copyrights, main_site_url, more_games_url, instructions_mobile, instructions_desktop, legal_special_1, legal_special_2;


var billing_block_version = -1;
var legal_block_scale = 1;
...
function doProcessData(){
  ...
  for(var s in oLANG){
    var o = oLANG[s];
    if(o.phase){
      if(parseInt(o.phase) != current_phase){
        continue;
      }
    }
    ...
    if(o.active == "true"){
      ...
      switch(o.type){
        ...
        case "legal_special_1":
          if(o.after == "break"){o.after = "<BR>";}
          legal_special_1.push({msg: o.id, after:o.after || null});
          break;

         case "legal_special_2":
          if(o.after == "break"){o.after = "<BR>";}
          legal_special_2.push({msg: o.id, after:o.after || null});
          break;

        case "legal_image":
          legal_images.push({src:o.value, alt:o.alt});
          break;

        case "legal_link":
          if(o.after == "break"){o.after = "<BR>";}
          legal_links.push({msg: o.id, link:o.link || null, action:o.action || null, after:o.after || null, classAdd:o.classAdd || null});
          break;

        case "legal_copyright":
          if(o.after == "break"){o.after = "<BR>";}
          legal_copyrights.push({msg: o.id, after:o.after || null});
          break;

        case "instruction_mobile":
          instructions_mobile.push({msg: o.id, img:o.img, w:o.w, h:o.h});
          break;

        case "instruction_desktop":
          instructions_desktop.push({msg: o.id, img:o.img, w:o.w, h:o.h});
          break;

        case "main_site_url":
              main_site_url = o.link;
              break;

        case "more_games_url":
              more_games_url = o.link;
              break;
      }
    }
}
...
function doBrowserAlert(){
  ...
  var my_html = "";
  my_html += '<table border="0" width="100%" height="100%" cellpadding="40"><tr><td align="center" valign="middle">';
  my_html += '<img border="0" width="245" src="' + oLANG_IMAGES.MovieLogo + '"/>'+ '<p>';
 

  //my_html += '<div class="film_logo_date">' +  date_msg.value + '</div><p>';
  my_html += oLANG.browser_alert.value + '<p>';
  my_html += '<a href="https://www.google.com/chrome/browser/"><img border="0" src="media/browser_icons/icon_chrome.png" width="64" height="64" alt="Chrome"/></a>';
  my_html += '<a href="http://www.mozilla.org/firefox/new/"><img border="0" src="media/browser_icons/icon_firefox.png" width="64" height="64" alt="Firefox"/></a>';
  my_html += '<a href="https://www.microsoft.com/microsoft-edge"><img border="0" src="media/browser_icons/icon_edge.png" width="64" height="64" alt="Edge"/></a>';
  my_html += '<a href="http://www.apple.com/safari/"><img border="0" src="media/browser_icons/icon_safari.png" width="64" height="64" alt="Safari"/></a>';
  my_html += '<a href="http://www.opera.com/"><img border="0" src="media/browser_icons/icon_opera.png" width="64" height="64" alt="Opera"/></a>';
  my_html += '</td></tr></table>';
