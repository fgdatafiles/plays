(function() {
    ...
    var p = c.extend(Slot22, c.Container);
    p._active = false;
    p.initialize = function() {
        console.log('Slot22 int');
        ...
        this.shape.graphics.f("#FF0000").s().p("AEwJPQgohdAth2QgdglgeAYQgyglgxAeQAOA2g2A3QhVAWhnBfIhUgNIg+iXIiEB+IhPAAIgthWQguoBBEolIAFAAIFGBaQgLA/AyAkIBDgZIAxAbQAogcACgxIFDA5QArAPALAwIgCACIAWM1QAGBIAYA2QgHASg9AAQgvAAhPgKg");
    ...
    window.Slot22 = c.promote(Slot22, "Container");
}());