function CAreYouSurePanel(oParentContainer) {
    ...
    this._init = function () {
        ...
        _oButYes = new CGfxButton(140, 50, s_oSpriteLibrary.getSprite('but_yes_big'), _oPanelContainer);
        _oButYes.addEventListener(ON_MOUSE_UP, this._onButYes, this);

        _oButNo = new CGfxButton(-140, 50, s_oSpriteLibrary.getSprite('but_exit_big'), _oPanelContainer);
