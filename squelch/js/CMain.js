function CMain(oData){
    ...
    this._initSounds = function(){
        ...
        if(navigator.userAgent.indexOf("Opera")>0 || navigator.userAgent.indexOf("OPR")>0){
				...
				createjs.Sound.registerSound("./sounds/SquelchiesMusic.ogg", "main");
				...
				createjs.Sound.registerSound("./sounds/SquelchiesMusic.mp3", "main");
    ...
    this._loadImages = function(){
		...
		s_oSpriteLibrary.addSprite("bg_instructions","./sprites/bg_instructions.jpg");
        s_oSpriteLibrary.addSprite("but_menu_bg","./sprites/but_menu_bg.png");
		s_oSpriteLibrary.addSprite("but_menu_bg2","./sprites/but_menu_bg2.png");
