(function() {
    ...
    p.initialize = function() {
        ...
        this.shape.graphics.f("rgba(255,0,0,0.996)").s().p("AgxHqQlhAGhqhcIgNg0QAzgNAmg5QB4AngHgpQAegajCj3IAzgkQA6gnAYguQDtiGAnj1IEsACQgWHcD3AUQgUA4AXAwQiEBXgPCSQBJAlBDh8QABBpBKAYQh8BulCAAQg8AAhBgEg");
        this.shape.setTransform(43, 5); //52.6,49.837);
