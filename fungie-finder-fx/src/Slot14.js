(function() {
    ...
    var p = c.extend(Slot14, c.Container);
    p._active = false;

    p.initialize = function() {
        console.log('Slot14 int');
        ...
        this.shape.graphics.f("rgba(255,0,0,0.51)").s().p("AAAOQIgCAJIppi0QE9rFAnuzIAEgOINSAAIAddDg");
    ...
    p.destroy = function() {
        console.log('destroy slot14');
        clearTimeout(p.timeout);
        t.removeAllChildren();
    }

    window.Slot14 = c.promote(Slot14, "Container");
}());