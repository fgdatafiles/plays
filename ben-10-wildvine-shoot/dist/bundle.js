...
/***/ function(module, exports, __webpack_require__) {
	...
	var _GameEnd = __webpack_require__(126);
	
	var _GameEnd2 = _interopRequireDefault(_GameEnd);
	
	var _screenfullMin = __webpack_require__(128);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _TimeStamp = __webpack_require__(113);
	...
	var _HeroMissile = __webpack_require__(115);
	
	var _HeroMissile2 = _interopRequireDefault(_HeroMissile);
	
	var _HazardExplosion = __webpack_require__(116);
	
	var _HazardExplosion2 = _interopRequireDefault(_HazardExplosion);
	
	var _GameHUD = __webpack_require__(117);
	...
	var _class = function (_Phaser$State) {
	  ...
	  (0, _createClass3.default)(_class, [{
	    ...
	    value: function create() {
	      ...
	      // hero
	      this.hero = new _Hero2.default(this.game, this.game.width / 2, this.game.height * 0.65);
	    ...
	    value: function update() {
	      ...
	      switch (this.state) {
	        case 0:
	          if (this.game.time.now - this.timeStamp.timeStart > 2500) this.state = 1;
	          break;
	        case 1:
	          this.checkHazardSpawn();
	          this.updateHazards();
	          if (game.input.activePointer.isDown) this.fire(this.game.input);
	          if (this.gameMode != "survival") this.updateTimedGame();
	          this.hud.setTimeDisplay(this.timeDuration);
	          if (this.timeDuration <= 5000) {
	            if (!this.game.sounds.isSoundPlaying("timesup")) {
	              this.game.sounds.playSoundEffect("timesup", false, 1);
	            }
	          }
	          break;
	        case 2:
	    ...
	    value: function checkHazardSpawn() {
	      ...
	      if (this.game.time.now - this.hazardLastSpawned > this.hazardSpawnDelay) {
	        ...
	        // set hazard position
	        hazard.position.set(tx, ty);
	
	        // rotate hazard towards hero - we wanna go that way!
	        //hazard.rotation = Phaser.Math.angleBetweenPoints(hazard, this.hero);
	        hazard.setDirection(Phaser.Math.angleBetweenPoints(hazard, this.hero));
	        hazard.reset();
	    ...
	    value: function destroyHazard(hazard) {
	      this.game.sounds.playSoundEffect("enemy", false, 0.5);
	    ...
	    value: function explodeParticles(x, y) {
	      ...
	      var count = arguments.length <= 2 || arguments[2] === undefined ? 50 : arguments[2];
	      var fill = arguments.length <= 3 || arguments[3] === undefined ? 0x505050 : arguments[3];
	      var stroke = arguments.length <= 4 || arguments[4] === undefined ? 0x505050 : arguments[4];
	    }
	  }, {
	    key: 'handlePause',
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _class = function (_Phaser$Sprite) {
	  ...
	  function _class(game, x, y, asset) {
	    ...
	    _this.game = game;
	    _this.costume = _this.game.add.sprite(0, 0, "hero");
	    _this.costume.anchor.set(0.5, 0);
	
	    _this.pointer = _this.game.make.sprite(6, 60, "hero_arm");
	    _this.pointer.anchor.set(0, 0.5);
	  ...
	  (0, _createClass3.default)(_class, [{
	    key: "aim",
	    value: function aim(angle) {
	      this.pointer.rotation = angle;
	      var degrees = Math.abs(angle * (180 / Math.PI));
	      var frame = Math.max(1, Math.min(25, Math.round(25 * (degrees / 180))));
	
	      if (frame < 10) frame = "0" + frame;
	      this.costume.frameName = "hero00" + frame + ".png";
	    }
	  }, {
	    key: "getLaunchPosition",
	    value: function getLaunchPosition() {
	      var x = this.x + this.pointer.x - 10;
	      var y = this.y + this.pointer.y;
	
	      x += this.pointer.height * Math.cos(this.pointer.rotation);
	      y += this.pointer.height * Math.sin(this.pointer.rotation);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _class = function (_Phaser$Sprite) {
	  ...
	  function _class(game, x, y, asset) {
	    ...
	    _this.test = _this.game.make.graphics();
	    _this.test.beginFill(0xFFFF00, 0.5);
	    _this.test.drawCircle(0, 0, 128);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _class = function (_Phaser$Sprite) {
	  ...
	  function _class(game, x, y, asset) {
	    (0, _classCallCheck3.default)(this, _class);
	    return (0, _possibleConstructorReturn3.default)(this, (_class.__proto__ || (0, _getPrototypeOf2.default)(_class)).call(this, game, x, y, "hero_missile"));
	  }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _ClockDisplay = __webpack_require__(118);
	
	var _ClockDisplay2 = _interopRequireDefault(_ClockDisplay);
	
	var _ScoreDisplay = __webpack_require__(119);
	
	var _ScoreDisplay2 = _interopRequireDefault(_ScoreDisplay);
	
	var _BtnPause = __webpack_require__(120);
	
	var _BtnPause2 = _interopRequireDefault(_BtnPause);
	
	var _IntructionMouseClick = __webpack_require__(121);
	...
	var _BtnSoundToggle = __webpack_require__(123);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _class = function (_Phaser$Sprite) {
	  ...
	  function _class(game, x, y, asset) {
	    ...
	    _this.copy = _this.game.make.text(_this.width / 2, _this.height / 2, '0', _this.game.data.styles.in_game_score);
	    _this.copy.setTextBounds(0, 0, _this.width, 100);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _BtnPlay = __webpack_require__(125);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _BtnReplay = __webpack_require__(127);
	...
	var _class = function (_Phaser$State) {
	    ...
	    (0, _createClass3.default)(_class, [{
	        ...
	        value: function renderPromotedGames() {
	            ...
	            this.btnReplay.position.set(this.game.width / 2, this.game.height * 0.3);
	            this.game.add.existing(this.btnReplay);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _defineProperties = __webpack_require__(129);
