function CMain(oData) {
    ...
    this._loadImages = function () {
		...
		s_oSpriteLibrary.addSprite("but_1p", "./sprites/but_1p.png");
		s_oSpriteLibrary.addSprite("but_2p", "./sprites/but_2p.png");
		...
		s_oSpriteLibrary.addSprite("bg_game_foreground", "./sprites/bg_game_foreground.png");
		...
		s_oSpriteLibrary.addSprite("flags_00", "./sprites/flags_00.png");
		s_oSpriteLibrary.addSprite("flags_01", "./sprites/flags_01.png");
		s_oSpriteLibrary.addSprite("flags_02", "./sprites/flags_02.png");
		s_oSpriteLibrary.addSprite("flags_03", "./sprites/flags_03.png");
		s_oSpriteLibrary.addSprite("flags_04", "./sprites/flags_04.png");
		s_oSpriteLibrary.addSprite("flags_05", "./sprites/flags_05.png");
		s_oSpriteLibrary.addSprite("flags_06", "./sprites/flags_06.png");
		s_oSpriteLibrary.addSprite("flags_07", "./sprites/flags_07.png");
		...
		s_oSpriteLibrary.addSprite("players2", "./sprites/players2.png");
    ...
    this.gotoTeamChoose = function (bMultiplayer) {
		_bMultiplayerMode = bMultiplayer;
        _oTeamChoose = new CTeamChoose(_bMultiplayerMode);
        _iState = STATE_MENU;
    };

    this.gotoGame = function (iTeamChoosed, iTeamTwoChoosed) {
        _oGame = new CGame(_oData, iTeamChoosed, _bMultiplayerMode, iTeamTwoChoosed);
        _iState = STATE_GAME;
    };
