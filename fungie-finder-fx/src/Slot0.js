(function() {
    ...
    p.initialize = function() {
        ...
        this.shape.graphics.f("rgba(255,0,0,0.996)").s().p("Au0M3IhE8jIfxhTIpnScQjDCLgPDAQhGAYgmCSQhuARhvA3QjEAvgTF3g");
        this.shape.setTransform(104.075, 108.4);
        this.shape.alpha = .8;
    ...
    p.onGetItem = function(e) {
        ...
        points_gfx.x = gfx.x - gfx.image.width * item.scale - 30;
        points_gfx.y = gfx.y - gfx.image.height * item.scale - 70;
