(function() {
    ...
    var p = c.extend(Slot28, c.Container);
    p._active = false;
    p.initialize = function() {
        console.log('Slot28 int');
        ...
        this.shape.graphics.f("#FF0000").s().p("ADFHYIg4jyQgQgngkAJQj/B2jpAIIAKufIMLACIAKCQQgDHugZHvQgsAzglARg");
    ...
    p.showGood = function(delay_scale) {
        ...
        if (number == 6 || number == 7 || number == 3 || number == 9) {
            gfx.scaleX = -1;
    ...
    window.Slot28 = c.promote(Slot28, "Container");
}());