(function() {
    ...
    var p = c.extend(Slot24, c.Container);
    p._active = false;
    p.initialize = function() {
        console.log('Slot24 int');
        ...
        this.shape.graphics.f("#FF0000").s().p("Am2INQgangAloPIBhh2QFEgPFkATIBjBWIgpOpIgXBxQgDAXgrAQIgCgEIpwAgQhpAAguhSg");
    ...
    window.Slot24 = c.promote(Slot24, "Container");
}());