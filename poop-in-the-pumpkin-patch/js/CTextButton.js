function CTextButton(iXPos,iYPos,oSprite,szText,szFont,szColor,iFontSize){
    ...
    this._init =function(iXPos,iYPos,oSprite,szText,szFont,szColor,iFontSize){
        ...
        _oTextBack.x = oSprite.width/2+10 + iStepShadow;
        _oTextBack.y = Math.floor((oSprite.height)/2) +(oBounds.height/4) + iStepShadow;

        _oText = new createjs.Text(szText,iFontSize+"px "+szFont, szColor);
        _oText.textAlign = "center";
        _oText.textBaseline = "alphabetic";
        var oBounds = _oText.getBounds();    
        _oText.x = oSprite.width/2+10;
        _oText.y = Math.floor((oSprite.height)/2) +(oBounds.height/4);
