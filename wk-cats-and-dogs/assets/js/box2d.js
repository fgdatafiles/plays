...
b2RayCastInput.prototype.maxFraction = 1;var Features = function() {
  this.__varz();
  this.__constructor.apply(this, arguments)
};
...
b2AABB.prototype.__varz = function() {
  ...
  this.centerV2 = new b2Vec2;
  this.extentsV2 = new b2Vec2
};
b2AABB.prototype.Reset = function()
{
...
b2Fixture.prototype.__varz = function() {
  ...
  this.m_aabb1 = new b2AABB;
  this.m_aabb2 = new b2AABB
};
...
b2BroadPhase.prototype.RayCast = function(callback, input) {
  ...
  var dx = (input.p2.x - input.p1.x) * this.m_quantizationFactor.x,
  	...
  	startValues2 = new Array;
  startValues[0] = ~~(p1x) & b2Settings.USHRT_MAX - 1;
  startValues[1] = ~~(p1y) & b2Settings.USHRT_MAX - 1;
...
//   console.log(this.lengthA, this.lengthB, ' :: ', this.maxLengthA, this.maxLengthB);
};
...
b2Color.prototype.__constructor = function(rr, gg, bb) {
  this._r = ~~(255 * b2Math.Clamp(rr, 0, 1));
  this._g = ~~(255 * b2Math.Clamp(gg, 0, 1));
  this._b = ~~(255 * b2Math.Clamp(bb, 0, 1))
};
...
b2ContactManager.prototype.AddPair = function(proxyUserDataA, proxyUserDataB) {
  ...
  var edge = bodyB.GetContactList(), fA, fB;
  while(edge) {
    if(edge.other == bodyA) {
