...
var updateStatTimer = 4200; //timer to update puki meter and XP --- 5000 is default speed ---
...
var default_data = {health:90, fun:90, xp:50, items:'ball,bubble,comb,hotdog,beans'};
...
function goPop(page){
	...
	switch(page){
		...
		case 'welcome':
			...
			welcomeHealth.x = (canvasW/2) - 510
			welcomeFun.x = (canvasW/2) - 510
			welcomeXP.x = (canvasW/2) - 490;
			
			welcomeHealth.y = (canvasH/100 * 35-100);
			welcomeFun.y = (canvasH/100 * 45-100);
			welcomeXP.y = (canvasH/100 * 55-100);
 ...
 */
 ...
 function startGame(){
	...
	togglePukiGravity();
	cursorX = canvasW/2;
	cursorY = puki_arr.y = pukiGround = canvasH/100 * 82-200;
...
function displayShopItems(){
	...
	buyIcon.x = canvasW/2-410;
	buyIcon.y = canvasH/2-50;
